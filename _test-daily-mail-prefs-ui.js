...
assert(html.includes("giDailySalesMailAddUserSelect"), "הוספת משתמש");
assert(html.includes("giDailySalesMailAddSlotBtn"), "הוספת מועד");
assert(html.includes("gi-daily-sales-mail.js?v=20260919-mail-prefs-ui-v1"), "cache bust js");
assert(html.includes("gi-daily-sales-mail.css?v=20260919-mail-prefs-ui-v1"), "cache bust css");
