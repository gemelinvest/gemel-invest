...
assert(app.includes('GI_WIZARD_JS_VERSION = "' + APP_TAG + '"'), "app wizard version");
assert(wiz.includes('GI_WIZARD_BUILD = "' + APP_TAG + '"'), "wizard build mark");
assert(app.includes("./gi-phoenix-ci-form.js?v=" + APP_TAG), "form chunk cache");
assert(form.includes('VERSION: "' + APP_TAG + '"'), "form VERSION");
