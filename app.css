...
.lcWizard__panel{ position:absolute; inset:14px; border-radius:22px; background: rgba(255,255,255,.94);
  border:1px solid rgba(15,23,42,.12); box-shadow: 0 40px 90px rgba(15,23,42,.30);
  display:grid; grid-template-rows: auto auto auto 1fr auto; overflow:hidden;
}
@media (max-width: 720px){ .lcWizard__panel{ inset:10px; } }
...
.lcWizard__body{ padding: 14px 16px 16px; overflow:auto; }
