...
(function installHachsharaCiForm(global){
  ...
  const HachsharaCiForm = {
    ...
    async open(rec){
      ...
      modal.className = "giValModal hachCiFormModal giPdfEditorModal is-open giValModal--visible";
      modal.innerHTML = `
        ...
        <div class="giValModal__card">
          ...
          <div class="giValModal__foot">
            ...
            <button type="button" class="btn btn--primary" data-hachci-download="1" disabled>הורד PDF רשמי</button>
          </div>
        </div>`;
      ...
      try {
        ...
        try { console.error("HACHSHARA_CI_EDITOR_FAILED", err); } catch(_e) {}
