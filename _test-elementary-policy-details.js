...
assert(indexHtml.includes("app.js?v=20260829-proposals-compact-v1"), "cache bust app.js");
assert(indexHtml.includes("app.css?v=20260829-proposals-compact-v1"), "cache bust app.css");
assert(sw.includes("20260829-proposals-compact-v1"), "service-worker version");
...
assert(indexHtml.includes("theme.css?v=20260829-proposals-compact-v1"), "cache bust theme.css");
