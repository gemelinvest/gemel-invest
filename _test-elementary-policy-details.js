...
assert(indexHtml.includes("app.js?v=20260908-hach-cpi-v1"), "cache bust app.js");
assert(indexHtml.includes("app.css?v=20260908-hach-cpi-v1"), "cache bust app.css");
assert(sw.includes("20260908-hach-cpi-v1"), "service-worker version");
...
assert(indexHtml.includes("theme.css?v=20260908-hach-cpi-v1"), "cache bust theme.css");
