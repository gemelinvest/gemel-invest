...
const checks = [
  ...
  [html, /app\.js\?v=20260919-exist-pol-status-dd-v1/, "app.js cache bust"],
  [html, /app\.css\?v=20260919-exist-pol-status-dd-v1/, "app.css cache bust"],
  [html, /theme\.css\?v=20260919-exist-pol-status-dd-v1/, "theme.css cache bust"],
  [html, /gi-face-auth\.js\?v=20260919-shift-modal-v1/, "gi-face-auth cache bust"],
  [sw, /gi-v12-20260919-exist-pol-status-dd-v1/, "service worker cache"],
