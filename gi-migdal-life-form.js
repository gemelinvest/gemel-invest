...
(function installMigdalLifeForm(global){
  ...
  const MigdalLifeForm = {
    ...
    VERSION: "20260824-migdal-life-form-v1",
    ...
    async fillOriginalTemplate(draft){
      ...
      this.setExport(form, "PayWay", draft.payWay);
    ...
    renderPreviewHtml(draft){
      ...
      return `<div class="migLifeFormPreview">
        ...
        ${rows}
        <button class="btn btn--primary" type="button" data-miglife-open="1">פתח טופס דיגיטלי</button>
      </div>`;
    },
    close(){
