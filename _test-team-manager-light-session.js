...
console.log("\ncache");
assert(indexHtml.includes("app.js?v=20260826-travel-insurance-v1"), "cache bust app.js");
assert(sw.includes("20260826-travel-insurance-v1"), "service-worker version");
