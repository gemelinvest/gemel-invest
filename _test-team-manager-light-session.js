...
console.log("\ncache");
assert(indexHtml.includes("app.js?v=20260826-daily-sales-branch-v4"), "cache bust app.js");
assert(sw.includes("20260826-daily-sales-branch-v4"), "service-worker version");
