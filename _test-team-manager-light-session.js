...
console.log("\ncache");
assert(indexHtml.includes("app.js?v=20260826-travel-insurance-v2"), "cache bust app.js");
assert(sw.includes("20260826-travel-insurance-v2"), "service-worker version");
