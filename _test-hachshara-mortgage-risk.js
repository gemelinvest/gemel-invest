...
assert(html.includes("app.js?v=20260826-hach-hmo-health-v1"), "index.html bumps app.js cache");
assert(sw.includes("gi-v12-20260826-hach-hmo-health-v1"), "service worker cache bumped");
