...
assert(html.includes("app.js?v=20260826-daily-sales-branch-v4"), "index.html bumps app.js cache");
assert(sw.includes("gi-v12-20260826-daily-sales-branch-v4"), "service worker cache bumped");
