...
assert(app.includes('GI_SIMULATOR_JS_HREF = "./gi-simulators.js?v=20260915-sys-notice-v1"'), "app.js loads bumped simulators chunk");
...
assert(html.includes("app.js?v=20260915-sys-notice-v1"), "index.html bumps app.js cache");
assert(sw.includes("gi-v12-20260915-sys-notice-v1"), "service worker cache bumped");
