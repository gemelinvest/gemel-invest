...
assert(app.includes('GI_SIMULATOR_JS_HREF = "./gi-simulators.js?v=20260907-chat-ignore-v1"'), "app.js loads bumped simulators chunk");
assert(app.includes('{ company: "הכשרה", product: "ריסק משכנתא" }'), "catalog lists הכשרה × ריסק משכנתא");
assert(app.includes("hachshara-mortgage-risk-sim.css?v=20260907-chat-ignore-v1"), "app.js loads mortgage CSS");
assert(html.includes("app.js?v=20260907-chat-ignore-v1"), "index.html bumps app.js cache");
assert(sw.includes("gi-v12-20260907-chat-ignore-v1"), "service worker cache bumped");
