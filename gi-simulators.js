...
;
  ...
  /* GI-MULTI-SELECT-OWN-DISCOUNT 2026-09-12
     בחירה מרובה אינה מעתיקה הנחה בין מבוטחים.
     כל מבוטח נשאר עם אפשרות ההנחה / ההנחה הידנית שלו, והפרמיה אחרי הנחה
     מחושבת לפי הנתונים והמוצר שלו בלבד. */
  ...
  function riskSimInstallShellEnhancer(handler){
    ...
    if(typeof handler.open === "function"){
      ...
      handler.open = function(ctx){
        ...
        const restoreDiscount = next.restoreDiscountByInsured;
          ...
          <div class="giValModal__body lcPhxSim__body">
            ...
            <div class="lcPhxSim__grid">
              ...
              <div class="lcPhxSim__field lcPhxSim__field--wide">
                ...
                <input class="lcPhxSim__input" type="text" inputmode="numeric" data-phx-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcPhxSim__field lcPhxSim__field--wide">
          ...
          <div class="giValModal__body lcMnrSim__body">
            ...
            <div class="lcMnrSim__grid">
              ...
              <div class="lcMnrSim__field lcMnrSim__field--wide">
                ...
                <input class="lcMnrSim__input" type="text" inputmode="numeric" data-mnr-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcMnrSim__field lcMnrSim__field--wide">
        ...
        <div class="giValModal__card lcMnrSim__card">
          ...
          <div class="giValModal__body lcMnrSim__body">
            ...
            <div class="lcMnrSim__grid">
              ...
              <div class="lcMnrSim__field lcMnrSim__field--wide">
                <label class="lcMnrSim__label">סכום ביטוח (₪)</label>
                <input class="lcMnrSim__input" type="text" inputmode="numeric" data-mnrmort-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcMnrSim__field lcMnrSim__field--wide">
                <label class="lcMnrSim__label">עיסוק</label>
  ...
  // ללא הצמדת מדד — בגיליון הריסק אין מדד בסיס (מדד 133.17 שייך רק לבריאות).
  //
  // [age, maleNonSmoker, maleSmoker, femaleNonSmoker, femaleSmoker] — פרמיה שנתית ל-1,000 ₪
  ...
  function computeHachsharaRiskPremium({ age, gender, smoker, sumInsured }){
    ...
    // ללא הצמדת מדד — בתעריפון הסיכונים אין מדד בסיס מתועד (בניגוד לבריאות 133.17).
    return {
      ok:true,
          ...
          <div class="giValModal__body lcHachRisk__body">
            ...
            <div class="lcHachRisk__grid">
              ...
              <div class="lcHachRisk__field lcHachRisk__field--wide">
                ...
                <input class="lcHachRisk__input" type="text" inputmode="numeric" data-hachr-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcHachRisk__field lcHachRisk__field--wide">
  ...
  // ללא הצמדת מדד — בגיליון המשכנתא אין מדד בסיס (מדד 133.17 שייך רק לבריאות).
  ...
  function computeHachsharaMortRiskPremium({ age, gender, smoker, sumInsured }){
    ...
    const annualPremium = (rateCenti * sum) / 100000;
    const monthlyPremium = Math.round((annualPremium / 12) * 100) / 100;
    // ללא הצמדת מדד — בתעריפון הסיכונים אין מדד בסיס מתועד.
    return {
      ok:true,
      ratePerMille: lookup.ratePerMille,
      monthlyPremium,
          ...
          <div class="giValModal__body lcHachMort__body">
            ...
            <div class="lcHachMort__grid">
              ...
              <div class="lcHachMort__field lcHachMort__field--wide">
                ...
                <input class="lcHachMort__input" type="text" inputmode="numeric" data-hachm-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcHachMort__field lcHachMort__field--wide">
        ...
        <div class="giValModal__card lcPhxSim__card">
          ...
          <div class="giValModal__body lcPhxSim__body">
            ...
            <div class="lcPhxSim__grid">
              ...
              <div class="lcPhxSim__field lcPhxSim__field--wide">
                <label class="lcPhxSim__label">סכום ביטוח (₪)</label>
                <input class="lcPhxSim__input" type="text" inputmode="numeric" data-phxmort-field="sumInsured" value="${escapeHtml(st.sumInsured || "")}" placeholder="" />
              </div>
              <div class="lcPhxSim__field lcPhxSim__field--wide">
                <label class="lcPhxSim__label">עיסוק</label>
  ...
  const HealthCpi = {
    ...
    TARIFFS: {
      ...
      hachshara_health: {
        ...
        // ריסק / משכנתא / מחלות קשות אינם משתמשים במדד זה (אין מדד בסיס בתעריפון הסיכונים).
  ...
  /** מדד בריאות הכשרה (133.17) — לבריאות בלבד. עזרי פורמט נשמרים לתצוגת בריאות. */
  ...
  // ללא הצמדת מדד — בגיליון מחלות קשות אין מדד בסיס (מדד 133.17 שייך רק לבריאות).
  ...
  function computeHachsharaCiPremium({ age, gender, smoker, compensation }){
    ...
    // ללא הצמדת מדד — בתעריפון הסיכונים אין מדד בסיס מתועד.
    const monthlyPremium = monthlyAgorot / 100;
    return {
      ok: true,
      monthlyAgorot,
      monthlyPremium,
