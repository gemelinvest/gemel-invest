...
assert(html.includes("app.js?v=20260919-exist-pol-layout-v1"), "index.html bumps app.js cache");
assert(html.includes("app.css?v=20260919-exist-pol-layout-v1"), "index.html bumps app.css cache");
