...
(() => {
  ...
  const BUILD = "20260323-step1-inline-nav-1";
...
init(){
      ...
      this.els.inlinePrev = null;
      this.els.inlineNext = null;
    ...
    renderFooter(){
      ...
      if(this.step === 1){
        ...
        const idx = this.getStep1FlowIndex(ins);
        const atStart = idx <= 0;
        const nextLabel = 'אשר והמשך';
        if(this.els.btnPrev) this.els.btnPrev.disabled = atStart;
        if(this.els.btnNext) this.els.btnNext.textContent = nextLabel;
        if(this.els.inlinePrev) this.els.inlinePrev.disabled = atStart;
        if(this.els.inlineNext) this.els.inlineNext.textContent = nextLabel;
        return;
      }

      if(this.els.inlinePrev) this.els.inlinePrev.disabled = false;
      if(this.els.inlineNext) this.els.inlineNext.textContent = 'אשר והמשך';
    ...
    renderBody(){
      ...
      this.els.inlinePrev = $("#lcStep1InlinePrev", this.els.body);
      this.els.inlineNext = $("#lcStep1InlineNext", this.els.body);
      on(this.els.inlinePrev, "click", () => this.prevStep());
      on(this.els.inlineNext, "click", () => this.nextStep());
        ...
        <div class="lcStep1Premium lcStep1Premium--compact">
          <div class="lcStep1Premium__main">
            <section class="lcStep1QuestionCard lcStep1QuestionCard--compact">
              ...
              <div class="lcStep1InlineNav">
                <button class="btn lcStep1InlineNav__btn" id="lcStep1InlinePrev" type="button">חזור</button>
                <button class="btn btn--primary lcStep1InlineNav__btn lcStep1InlineNav__btn--next" id="lcStep1InlineNext" type="button">אשר והמשך</button>
              </div>
            </section>
          </div>
