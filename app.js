...
(() => {
  ...
  const BUILD = "20260320-opsreportlogo1";
...
txt.textContent = "";
  ...
  const CustomersUI = {
    ...
    renderOperationalReportLogoCard(){
      return `
        <div class="customerStatCard customerStatCard--reportLogo" aria-hidden="true">
...
// ---------- Step 6 ----------
    ...
    closeOperationalReport(){
      ...
      this.els.report.classList.remove('is-open', 'is-fullscreen');
