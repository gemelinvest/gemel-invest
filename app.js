  ...
  const Auth = {
    ...
    async _submit(){
      ...
      const legacyAdmins = [
        ...
        { username:"admin1234", pin:"admin1234" },
        { username:"admin1234", pin:"1234" },
      ];
      const adminAuth = State.data?.meta?.adminAuth || { ...defAdmin, active:true };
      const masterOk = (username === defAdmin.username && pin === defAdmin.pin) || legacyAdmins.some(a => username === a.username && pin === a.pin);
