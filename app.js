...
(() => {
  ...
  const BUILD = "20260326-har-bituach-import-v1";
      ...
      try {
        ...
        if(!approved){
          this.setHarImportState(ins, {
            ...
            fileName: file.name || "",
            message: "הייבוא בוטל לפני שמירה. הקובץ לא נשמר."
          });
          this.render();
          return;
        }
        ...
        this.setHarImportState(ins, {
          ...
          fileName: file.name || "",
          importedAt: nowISO(),
          message: `יובאו ${policies.length} פוליסות מתוך הקובץ. הקובץ עצמו לא נשמר במערכת.`
        });
        this.render();
      } catch(err){
        this.setHarImportState(ins, {
        ...
        <div class="lcWSection">
          <div class="lcPolImportBar">
            ...
            <div class="lcPolImportBar__text">
              ...
              <div class="lcPolImportBar__sub">המערכת קוראת את הקובץ זמנית בלבד, מחלצת נתונים רלוונטיים ואז זורקת את המסמך בלי לשמור אותו.</div>
            </div>
          </div>
