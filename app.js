...
if(path === "birthDate"){
  ...
  return;
          ...
          // step3 existing policies: rerender when type/company changes (needed for dynamic fields like Health covers)
          if(path.startsWith("existingPolicies.") && (path.endsWith(".type") || path.endsWith(".company") || path.endsWith(".hasPledge") || path.endsWith(".pledgeBankName"))){
            this.render();
            return;
          }
      ...
      // health covers drawer (Step 3): open on button
      ...
      return `
        <div class="lcWSection">
          ...
          <div style="padding:12px 12px 0">
            <button class="btn" id="lcAddExistingPolicy" type="button">➕ הוסף פוליסה קיימת</button>
          </div>
        </div>
      `;
    },
