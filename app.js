...
(() => {
  ...
  const BUILD = "20260325-health-covers-extended-v8";
...
txt.textContent = "";
  ...
  const CustomerEditUI = {
    ...
    healthCovers: [
      ...
      { k:"יעוץ ובדיקות מורחב", sub:"כיסוי מורחב לייעוץ, בדיקות ואבחונים" },
      { k:"טיפולים בטכנולוגיות מתקדמות", sub:"טיפולים רפואיים בטכנולוגיות מתקדמות" },
      { k:"טיפולים להתפתחות הילד", sub:"שירותי אבחון וטיפולים להתפתחות הילד" },
      { k:"יעוץ אונליין", sub:"שירותי ייעוץ רפואי אונליין" },
      { k:"ביקור רופא ומעבדה עד הבית", sub:"רופא ובדיקות מעבדה עד הבית" }
    ],
init(){
