...
(() => {
  ...
  const BUILD = "20260412-vToolsWorkspaceFix";
  ...
  const TOOLS_WORKSPACE_URL = "https://oriasomech-jpg.github.io/TalkMe/";
  const TOOLS_WORKSPACE_URL_STORAGE_KEY = "GI_TOOLS_WORKSPACE_URL_V1";
...
UsersGateUI.init();
    ...
    goView(view){
      ...
      if (safe === "discountSpec") this.renderDiscountSpecView();
    },
