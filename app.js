...
(() => {
  ...
  const BUILD = "20260402-new-policy-screen-v25";
      ...
      const form = `<div class="lcWSection lcPolBuilderSection lcPolBuilderSection--reference">
        <div class="lcPolScreenHero">
          ...
          <div class="lcPolScreenHero__text">
            ...
            <div class="lcPolScreenHero__sub">${escapeHtml((this.insureds.find(x => x.id === d.insuredId)?.label) || safeTrim(this.insureds?.[0]?.label) || "מבוטח ראשי")}${d.insuredMode === "couple" ? " + בן/בת זוג" : ""}</div>
          </div>
        </div>
