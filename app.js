...
(() => {
  ...
  const BUILD = "20260411-vPerformanceFixMAX";
  ...
  const SUPABASE_CONNECTION_RETRY_DELAY_MS = 2200;
  const SUPABASE_KEEPALIVE_MS = 120000;

  const SUPABASE_SAVE_VERIFY_RETRY_COUNT = 4;
  const SUPABASE_SAVE_VERIFY_RETRY_DELAY_MS = 900;
