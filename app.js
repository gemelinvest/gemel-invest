...
(() => {
  ...
  const BUILD = "20260330-har-inline-cancel-actions-v13";
      ...
      return `
        <div class="${wrapCls}">
          <div class="lcPolicyActionBox__top">
            <div>
              <div class="lcPolicyActionBox__title">פעולה על הפוליסה</div>
              <div class="lcPolicyActionBox__sub">בחר כבר עכשיו סטטוס טיפול וסיבת ביטול במידת הצורך.</div>
            </div>
