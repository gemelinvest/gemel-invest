  ...
  const Wizard = {
            ...
            <div class="lcMedGrid">
              ...
              <div class="lcFormGrid lcFormGrid--2">
                <div class="field">
                  ...
                  <input class="input lcNum" type="number" step="0.1" inputmode="decimal" data-med-id="${p.id}" data-med-k="heightCm" autocomplete="off" value="${escapeAttr(m.heightCm)}" />
                </div>

                <div class="field">
                  <label class="label">משקל (ק״ג) *</label>
                  <input class="input lcNum" type="number" step="0.1" inputmode="decimal" data-med-id="${p.id}" data-med-k="weightKg" autocomplete="off" value="${escapeAttr(m.weightKg)}" />
                </div>
              </div>
            </div>
          </div>
    ...
    updateMedicalCard(id){
      ...
      if(riskEl){
        ...
        riskEl.textContent = "סיכון: " + String(risk.label||"").replace(/\s*\(.*?קטין.*?\)/g,"").trim();
      }
    },
