        ...
        <div class="lcWSection">
          <div class="row row--between">
            <div>
              ...
              <div class="muted small">לכל מבוטח בנפרד · ניתן להוסיף, לערוך ולהסיר פוליסות. הלוגו מתעדכן אוטומטית לפי החברה שנבחרה.</div>
            </div>
            <button class="btn" id="lcAddExistingPolicy" type="button">➕ הוסף פוליסה</button>
          </div>

          <div class="lcPolTableWrap" style="padding:10px 0 0">
