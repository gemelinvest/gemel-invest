...
(() => {
  ...
  const BUILD = "20260324-operational-report-direct-pdf-5";
  ...
  const PDF_HEBREW_FONT_BASE64 = "";
  let pdfHebrewFontReady = false;

  function ensureOperationalPdfFont(pdf){
    if(!pdf || typeof pdf.addFileToVFS !== 'function' || typeof pdf.addFont !== 'function') return null;
    const fontFile = 'NotoSansHebrew-SemiCondensed.ttf';
    const fontName = 'NotoSansHebrew';
    try{
      if(!pdf.__giHebrewFontInstalled){
        try { pdf.addFileToVFS(fontFile, PDF_HEBREW_FONT_BASE64); } catch(_e) {}
        try { pdf.addFont(fontFile, fontName, 'normal'); } catch(_e) {}
        pdf.__giHebrewFontInstalled = true;
      }
      return fontName;
    }catch(_err){
      return null;
      ...
      try{
        ...
        img.onload = () => {
          try{
            ...
            if(!ctx || !canvas.width || !canvas.height) return resolve('');
...
// ---------- Step 6 ----------
    ...
    getOperationalReportFieldLabel(path, fallback=''){
      const labels = {
        firstName:'שם פרטי', lastName:'שם משפחה', fullName:'שם מלא', label:'שם מבוטח', type:'סוג מוצר / מבוטח',
        idNumber:'תעודת זהות', birthDate:'תאריך לידה', age:'גיל', gender:'מגדר', maritalStatus:'מצב משפחתי',
        phone:'טלפון', email:'אימייל', city:'עיר', street:'רחוב', houseNumber:'מספר בית', houseNo:'מספר בית', apartment:'דירה', apartmentNo:'דירה', zip:'מיקוד',
        clinic:'קופת חולים', hmo:'קופת חולים', kupatHolim:'קופת חולים', shaban:'שב״ן', shabanLevel:'שב״ן', occupation:'עיסוק',
        heightCm:'גובה', height:'גובה', weightKg:'משקל', weight:'משקל', bmi:'BMI', smoking:'עישון', smokingStatus:'עישון',
        company:'חברה', product:'מוצר', policyNumber:'מספר פוליסה', monthlyPremium:'פרמיה חודשית', premium:'פרמיה חודשית', premiumMonthly:'פרמיה חודשית',
        status:'סטטוס', policyStatus:'סטטוס', actionStatus:'סטטוס', action:'סטטוס',
        sumInsured:'סכום ביטוח', compensation:'סכום פיצוי', startDate:'תאריך תחילת ביטוח', coverage:'כיסוי / סכום / פיצוי', coverages:'כיסויים',
        healthCovers:'כיסויים', covers:'כיסויים',
        discountPct:'אחוז הנחה', discountYears:'שנות הנחה', premiumBefore:'פרמיה לפני הנחה', premiumAfter:'פרמיה אחרי הנחה',
        insuredMode:'אופן שיוך', insuredId:'מזהה מבוטח', pledge:'יש שיעבוד', hasPledge:'יש שיעבוד', bankAgency:'סוכנות בנקאית', bankAgencyName:'שם סוכנות',
        selectedPayerId:'מבוטח משלם', payerChoice:'מי משלם', paymentMethod:'אמצעי תשלום',
        relation:'קרבה למבוטח', holderName:'שם מחזיק', holderId:'ת.ז מחזיק', cardNumber:'מספר כרטיס', exp:'תוקף',
        account:'מספר חשבון', branch:'סניף', bankName:'שם בנק', bankNo:'מספר בנק',
        'pledgeBank.bankName':'שם בנק לשיעבוד', 'pledgeBank.bankNo':'מספר בנק לשיעבוד', 'pledgeBank.branch':'סניף לשיעבוד', 'pledgeBank.amount':'סכום לשיעבוד', 'pledgeBank.years':'לכמה שנים', 'pledgeBank.address':'כתובת הבנק',
        pledgeBankName:'שם בנק לשיעבוד', mortgageAmount:'סכום משכנתא', mortgageYears:'שנות משכנתא', mortgageAddress:'כתובת נכס'
      };
      return safeTrim(labels[path] || labels[String(path).split('.').pop()] || fallback || path);
    },

    getOperationalReportValueText(value, path=''){
      if(Array.isArray(value)){
        const items = value.map((item) => this.getOperationalReportValueText(item, path)).filter(Boolean);
        return items.join(', ');
      }
      ...
      if(typeof value === 'boolean'){
        if(path === 'payerChoice') return value ? 'כן' : 'לא';
        return value ? 'כן' : 'לא';
      }
      const raw = safeTrim(value);
      if(!raw) return '';
      if(path === 'payerChoice'){
        if(raw === 'insured') return 'מבוטח';
        if(raw === 'external') return 'משלם חיצוני';
      }
      if(path === 'paymentMethod'){
        if(raw === 'cc') return 'כרטיס אשראי';
        if(raw === 'ho') return 'הוראת קבע';
      }
    ...
    flattenOperationalEntries(source, prefix='', out=[]){
      if(!source || typeof source !== 'object') return out;
      Object.entries(source).forEach(([key, value]) => {
        if(value === null || value === undefined) return;
        const nextPath = prefix ? `${prefix}.${key}` : key;
        if(Array.isArray(value)){
          const arrayText = this.getOperationalReportValueText(value, nextPath);
          if(arrayText) out.push([nextPath, arrayText]);
          return;
        }
        if(value && typeof value === 'object'){
          this.flattenOperationalEntries(value, nextPath, out);
          return;
        }
        const text = this.getOperationalReportValueText(value, nextPath);
        if(text) out.push([nextPath, text]);
      });
      return out;
    },

    buildOperationalFieldRows(source, preferredOrder = [], options = {}){
      const entries = this.flattenOperationalEntries(source || {});
      const skip = new Set([
        'id','label','type','firstName','lastName','healthDeclaration','operationalAgentNumbers','policyPayers','newPolicies','existingPolicies','cancellations'
      ].concat(Array.isArray(options.skipKeys) ? options.skipKeys : []));
      const rows = [];
      const added = new Set();
      const take = (path) => {
        if(!path || added.has(path)) return;
        const found = entries.find(([entryPath]) => entryPath === path);
        if(!found) return;
        const value = this.getOperationalReportValueText(found[1], path);
        if(!value) return;
        rows.push([this.getOperationalReportFieldLabel(path), this.renderReportValue(value)]);
        added.add(path);
      };
      preferredOrder.forEach(take);
      entries.forEach(([path, value]) => {
        const leaf = String(path).split('.').pop();
        if(added.has(path) || skip.has(path) || skip.has(leaf)) return;
        const text = this.getOperationalReportValueText(value, path);
        if(!text) return;
        rows.push([this.getOperationalReportFieldLabel(path), this.renderReportValue(text)]);
        added.add(path);
      });
      return rows;
    },

    buildOperationalListLines(source, preferredOrder = [], options = {}){
      const rows = this.buildOperationalFieldRows(source, preferredOrder, options);
      return rows.map(([label, value]) => `${safeTrim(label)}: ${String(value).replace(/<[^>]+>/g, '').trim()}`);
    },

    getOperationalPaymentRows(payload){
      ...
      const payerChoice = safeTrim(host?.payerChoice || primary?.payerChoice || 'insured');
      const selectedPayerId = safeTrim(host?.selectedPayerId || primary?.selectedPayerId);
      const externalPayer = Object.assign({}, primary?.externalPayer || {}, host?.externalPayer || {});
      const cc = Object.assign({}, primary?.cc || {}, host?.cc || {});
      const ho = Object.assign({}, primary?.ho || {}, host?.ho || {});
      const method = safeTrim(host?.paymentMethod || primary?.paymentMethod || 'cc');
      const selectedIns = insureds.find((ins) => String(ins?.id || '') === String(selectedPayerId || '')) || insureds[0] || null;
      const selectedInsData = selectedIns?.data && typeof selectedIns.data === 'object' ? selectedIns.data : {};
      const payerName = payerChoice === 'external'
        ? `${safeTrim(externalPayer.firstName)} ${safeTrim(externalPayer.lastName)}`.trim()
        : safeTrim(((selectedInsData.firstName || '') + ' ' + (selectedInsData.lastName || '')).trim()) || safeTrim(selectedIns?.label);
      const rows = [
        ['מי משלם', this.renderReportValue(payerChoice === 'external' ? 'משלם חיצוני' : 'מבוטח')],
        ['שם משלם', this.renderReportValue(payerName)],
        ['מזהה מבוטח משלם', this.renderReportValue(selectedPayerId)],
        ['אמצעי תשלום', this.renderReportValue(method === 'cc' ? 'כרטיס אשראי' : method === 'ho' ? 'הוראת קבע' : method)]
      ];
      if(payerChoice === 'external'){
        rows.push(
          ['קרבה למבוטח', this.renderReportValue(externalPayer.relation)],
          ['שם פרטי משלם', this.renderReportValue(externalPayer.firstName)],
          ['שם משפחה משלם', this.renderReportValue(externalPayer.lastName)],
          ['ת.ז משלם', this.renderReportValue(externalPayer.idNumber)],
          ['תאריך לידה משלם', this.renderReportValue(externalPayer.birthDate)],
          ['טלפון משלם', this.renderReportValue(externalPayer.phone)]
        );
      }
      if(method === 'cc'){
        rows.push(
          ['שם מחזיק אשראי', this.renderReportValue(cc.holderName)],
          ['ת.ז מחזיק אשראי', this.renderReportValue(cc.holderId)],
          ['מספר כרטיס', this.renderReportValue(cc.cardNumber)],
          ['תוקף כרטיס', this.renderReportValue(cc.exp)]
        );
      } else if(method === 'ho'){
        rows.push(
      ...
      return rows.filter(([label, value]) => safeTrim(label) && safeTrim(value));
    },
    ...
    normalizeOperationalReportPayload(rawPayload){
      ...
      const primaryInsData = payload.insureds[0]?.data && typeof payload.insureds[0].data === 'object' ? payload.insureds[0].data : null;
      if(primaryInsData){
        const syncKeys = ['firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation','heightCm','height','weightKg','weight','bmi','payerChoice','selectedPayerId','paymentMethod'];
        syncKeys.forEach((key) => {
          if(!safeTrim(payload.primary?.[key]) && safeTrim(primaryInsData?.[key])) payload.primary[key] = primaryInsData[key];
          if(!safeTrim(primaryInsData?.[key]) && safeTrim(payload.primary?.[key])) primaryInsData[key] = payload.primary[key];
        });
        ['externalPayer','cc','ho','healthDeclaration','operationalAgentNumbers'].forEach((key) => {
          if((!payload.primary?.[key] || typeof payload.primary[key] !== 'object') && primaryInsData?.[key] && typeof primaryInsData[key] === 'object'){
            payload.primary[key] = JSON.parse(JSON.stringify(primaryInsData[key]));
          }
          if((!primaryInsData?.[key] || typeof primaryInsData[key] !== 'object') && payload.primary?.[key] && typeof payload.primary[key] === 'object'){
            primaryInsData[key] = JSON.parse(JSON.stringify(payload.primary[key]));
          }
        });
      }
    ...
    renderOperationalReport(payloadOverride){
      ...
      const customerRows = this.buildOperationalFieldRows(primary, [
        'firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation'
      ], { skipKeys:['cc','ho','externalPayer','healthDeclaration'] });

      const medicalRows = this.buildOperationalFieldRows(primary, [
        'heightCm','height','weightKg','weight','bmi','smokingStatus','smoking'
      ], { skipKeys:['cc','ho','externalPayer','healthDeclaration'] });
      ...
      insureds.forEach((ins) => {
        ...
        existingPolicies.forEach((p, idx) => {
          ...
          existingRows.push([
            ...
            this.renderReportValue(p?.monthlyPremium || p?.premium),
          ...
          const detailRows = this.buildOperationalFieldRows(p, [
            'company','type','policyNumber','monthlyPremium','premium','status','policyStatus','actionStatus','action','sumInsured','compensation','hasPledge','pledgeBankName','bankAgency','bankAgencyName'
          ], { skipKeys:['id'] });
          existingPolicyBlocks.push(`<article class="lcReportCard lcReportPolicyCard">
            <div class="lcReportPolicyCard__head">
              <div>
                <div class="lcReportPolicyCard__eyebrow">פוליסה קיימת ${idx + 1}</div>
                <div class="lcReportPolicyCard__title">${escapeHtml(safeTrim(ins?.label) || 'מבוטח')} · ${escapeHtml(safeTrim(p?.company) || 'חברה')} · ${escapeHtml(safeTrim(p?.type) || 'מוצר')}</div>
              </div>
              ${this.renderReportStatusBadge(statusMeta.label, statusMeta.tone)}
            </div>
            ${this.renderReportRowsList(detailRows, { dense:true, emptyText:'לא נמצאו נתוני פוליסה להצגה.' })}
          </article>`);
        });
      });
      ...
      const newPolicyBlocks = newPolicies.map((p, idx) => {
        ...
        ].concat(this.buildOperationalFieldRows(p, [
          'insuredMode','insuredId','company','type','premiumMonthly','premiumBefore','discountPct','startDate','sumInsured','compensation','coverage','coverages','healthCovers','pledge','pledgeBank.bankName','pledgeBank.bankNo','pledgeBank.branch','pledgeBank.amount','pledgeBank.years','pledgeBank.address'
        ], { skipKeys:['company','type','premiumMonthly','startDate','sumInsured','compensation','coverage','coverages','healthCovers','insuredMode','insuredId','pledge'] }));
      ...
      const payerRows = this.getOperationalPaymentRows(payload);
      ...
      const insuredCards = insureds.length
        ? insureds.map((ins, index) => {
            ...
            const rows = this.buildOperationalFieldRows(d, [
              'firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation','heightCm','height','weightKg','weight','bmi','smokingStatus','smoking'
            ], { skipKeys:['existingPolicies','newPolicies','healthDeclaration','operationalAgentNumbers','cc','ho','externalPayer'] });
      ...
      return `<div class="lcReportDoc lcReportDoc--modern">
        <section class="lcReportShowcase">
          ...
          <section class="lcReportSection lcReportSection--soft">
            ...
            <div class="lcReportSection__sub">הסטטוס מוצג בדיוק לפי מה שהנציג מילא בהקמת הלקוח, ומתחת לטבלה יש פירוט מלא של כל שדה שהוזן בכל פוליסה.</div>
            ${this.renderTable(['מבוטח','חברה','סוג ביטוח','מספר פוליסה','פרמיה חודשית','סטטוס'], existingRows)}
            <div class="lcReportStack">${existingPolicyBlocks.length ? existingPolicyBlocks.join('') : '<div class="muted">לא נוספו פוליסות קיימות.</div>'}</div>
          </section>
    ...
    _getOperationalPdfSections(payloadOverride){
      ...
      addKeyValues('פרטי לקוח', this.buildOperationalFieldRows(primary, [
        'firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation'
      ], { skipKeys:['cc','ho','externalPayer','healthDeclaration'] }).map(([label, value]) => [label, String(value).replace(/<[^>]+>/g, '').trim()]), sections);

      insureds.forEach((ins, index) => {
        const d = ins?.data || {};
        addKeyValues(`פרטי מבוטח — ${safeTrim(ins?.label) || `מבוטח ${index + 1}`}`, this.buildOperationalFieldRows(d, [
          'firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation','heightCm','height','weightKg','weight','bmi','smokingStatus','smoking'
        ], { skipKeys:['existingPolicies','newPolicies','healthDeclaration','operationalAgentNumbers','cc','ho','externalPayer'] }).map(([label, value]) => [label, String(value).replace(/<[^>]+>/g, '').trim()]), sections);
      });
    ...
    async exportOperationalPdf(payloadOverride){
      ...
      try{
        if(triggerBtn) triggerBtn.textContent = 'מייצא PDF...';
        ...
        const newPolicies = Array.isArray(payload?.newPolicies) ? payload.newPolicies : [];
        const now = new Date();
        const exportedDateLabel = now.toLocaleDateString('he-IL');
        const exportedTimeLabel = now.toLocaleTimeString('he-IL', { hour:'2-digit', minute:'2-digit' });
        const customerName = safeTrim(((primary.firstName || '') + ' ' + (primary.lastName || '')).trim()) || safeTrim(payload?.fullName) || 'לקוח ללא שם';
        const agentName = safeTrim(Auth?.current?.name) || safeTrim(payload?.agentName) || 'נציג מטפל';
        const logoSrc = safeTrim(document.querySelector('.brand__logoImg, .lcLogin__logoImg')?.src) || './logo-login-clean.png';
        const logoData = await loadImageAsDataUrl(logoSrc);

        const pdf = new JsPdfCtor({ orientation:'p', unit:'pt', format:'a4', compress:true });
        const fontName = ensureOperationalPdfFont(pdf) || 'helvetica';
        ...
        const prepare = (value) => textForPdf(stripHtml(value));
        const split = (value, width, size=10, fallback='—') => {
          pdf.setFont(fontName, 'normal');
          pdf.setFontSize(size);
          const prepared = prepare(value) || fallback;
          const lines = pdf.splitTextToSize(prepared, width, { lang:'he' });
          return Array.isArray(lines) && lines.length ? lines : [prepared];
        };
        const sectionPill = (title, y) => {
          pdf.setFillColor(...colors.soft);
          pdf.roundedRect(marginX, y, contentW, 20, 10, 10, 'F');
          setText(...colors.navy);
          pdf.setFont(fontName, 'normal');
          pdf.setFontSize(11.6);
          pdf.text(prepare(title), pageW - marginX - 14, y + 13.5, { align:'right' });
          return y + 28;
        };
        const drawHeader = (subtitle) => {
          ...
          pdf.roundedRect(marginX, y, contentW, 86, 24, 24, 'F');
          if(logoData){
            try{ pdf.addImage(logoData, 'PNG', marginX + 18, y + 20, 112, 34, undefined, 'FAST'); }catch(_e){}
          }
          setText(255,255,255);
          pdf.setFont(fontName, 'normal');
          pdf.setFontSize(26);
          pdf.text(prepare('דוח תפעולי'), pageW - marginX - 18, y + 28, { align:'right' });
          pdf.setFontSize(12.6);
          pdf.text(prepare(subtitle || 'פתרון פיננסי ללקוח'), pageW - marginX - 18, y + 48, { align:'right' });
          pdf.setFontSize(10.4);
          pdf.text(prepare('GEMEL INVEST · מסמך פנימי למחלקת תפעול'), pageW - marginX - 18, y + 64, { align:'right' });
          y += 101;
          ...
          metaPairs.forEach(([label, value], index) => {
            const x = pageW - marginX - (index * colW) - 4;
            setText(...colors.muted);
            pdf.setFontSize(9.2);
            pdf.text(prepare(label), x, y, { align:'right' });
            setText(...colors.navy);
            pdf.setFontSize(11.2);
            pdf.text(prepare(value), x, y + 14, { align:'right' });
          });
          return y + 28;
        };
        const drawFooter = (pageIndex) => {
          pdf.setDrawColor(...colors.line);
          pdf.line(marginX, pageH - bottomMargin - 14, pageW - marginX, pageH - bottomMargin - 14);
          setText(...colors.muted);
          pdf.setFontSize(8.8);
          pdf.text(prepare(`עמוד ${pageIndex}`), pageW - marginX, pageH - bottomMargin, { align:'right' });
          pdf.text(prepare('מסמך פנימי · הופק ישירות מתוך המערכת'), marginX, pageH - bottomMargin, { align:'left' });
        };
        const pairRows = (rows, fieldsPerRow=2) => {
          const out = [];
          const clean = (rows || []).filter(([label, value]) => prepare(label) && prepare(value));
          for(let i = 0; i < clean.length; i += fieldsPerRow){
            out.push(clean.slice(i, i + fieldsPerRow));
          }
          return out;
        };
        const drawKvGrid = (rows, y, options = {}) => {
          const grouped = pairRows(rows, options.fieldsPerRow || 2);
          if(!grouped.length){
            const h = 30;
            pdf.setDrawColor(...colors.line);
            pdf.setFillColor(255,255,255);
            pdf.roundedRect(marginX, y, contentW, h, 10, 10, 'FD');
            setText(...colors.muted);
            pdf.setFontSize(10);
            pdf.text(prepare('לא נמצאו נתונים להצגה'), pageW - marginX - 12, y + 18, { align:'right' });
            return y + h + 8;
          }
          const pairCount = options.fieldsPerRow || 2;
          const colW = contentW / pairCount;
          const labelW = options.labelW || 64;
          const padX = 10;
          const valueGap = 8;
          const fontSize = options.fontSize || 9.4;
          const lineH = options.lineH || 12.2;
          grouped.forEach((row) => {
            const pairLineCounts = row.map(([label, value]) => split(value, colW - labelW - (padX * 2) - valueGap, fontSize).length || 1);
            const maxLines = Math.max(1, ...pairLineCounts);
            const rowH = Math.max(28, 12 + (maxLines * lineH));
            pdf.setDrawColor(...colors.line);
            pdf.setFillColor(255,255,255);
            pdf.roundedRect(marginX, y, contentW, rowH, 10, 10, 'FD');
            row.forEach(([label, value], idx) => {
              const cellX = pageW - marginX - ((idx + 1) * colW);
              const labelX = cellX + colW - padX;
              const valueX = labelX - labelW - valueGap;
              if(idx > 0){
                pdf.setDrawColor(...colors.line);
                pdf.line(cellX, y + 6, cellX, y + rowH - 6);
              }
              pdf.setFillColor(...colors.soft2);
              pdf.roundedRect(labelX - labelW + 4, y + 4, labelW, rowH - 8, 8, 8, 'F');
              setText(...colors.navy);
              pdf.setFontSize(fontSize);
              pdf.text(prepare(label), labelX, y + 17, { align:'right' });
              setText(...colors.text);
              pdf.text(split(value, colW - labelW - (padX * 2) - valueGap, fontSize), valueX, y + 17, { align:'right' });
            });
            y += rowH + 6;
          });
          return y + 2;
        ...
        const splitIntoColumns = (items, columns = 2) => {
          ...
          clean.forEach((item, index) => out[index % columns].push(item));
          return out;
        };
        const drawPolicyCards = (cards, y, options = {}) => {
          const cardsList = Array.isArray(cards) ? cards : [];
          if(!cardsList.length){
            return drawKvGrid([['סטטוס', 'לא נמצאו נתונים להצגה']], y, { fieldsPerRow:1, fontSize:9.3 });
          }
          const compact = cardsList.length >= 3;
          const titleSize = compact ? 10.4 : 10.8;
          const subtitleSize = compact ? 8.6 : 8.9;
          const bodySize = compact ? 7.5 : 7.9;
          const bodyLineH = compact ? 9.2 : 9.6;
          cardsList.forEach((card, cardIndex) => {
            const lineCols = splitIntoColumns(card.lines || [], 2);
            const leftW = (contentW - 26) / 2;
            const colLineCounts = lineCols.map((items) => Math.max(1, ...items.map((item) => split(item, leftW, bodySize, '').length || 1), 0));
            const bodyLines = Math.max(colLineCounts[0] || 0, colLineCounts[1] || 0);
            const cardH = 38 + Math.max(bodyLineH * Math.max(bodyLines, 1), 18) + (compact ? 12 : 16);
            pdf.setDrawColor(...colors.line);
            pdf.setFillColor(255,255,255);
            pdf.roundedRect(marginX, y, contentW, cardH, 12, 12, 'FD');
            pdf.setFillColor(...colors.soft2);
            pdf.roundedRect(marginX + 1, y + 1, contentW, 26, 12, 12, 'F');
            setText(...colors.navy);
            pdf.setFontSize(titleSize);
            pdf.text(prepare(card.title || `פוליסה ${cardIndex + 1}`), pageW - marginX - 12, y + 16, { align:'right' });
            setText(...colors.muted);
            pdf.setFontSize(subtitleSize);
            pdf.text(prepare(card.subtitle || ''), pageW - marginX - 12, y + 27, { align:'right' });
            if(card.badge){
              const badgeX = marginX + 10;
              const badgeW = 118;
              const tone = card.badgeTone === 'danger' ? colors.danger : (card.badgeTone === 'warn' ? colors.warn : (card.badgeTone === 'success' ? colors.success : colors.blue));
              pdf.setFillColor(...tone);
              pdf.roundedRect(badgeX, y + 8, badgeW, 14, 7, 7, 'F');
              setText(255,255,255);
              pdf.setFontSize(8.1);
              pdf.text(prepare(card.badge), badgeX + badgeW - 8, y + 18, { align:'right' });
            }
            const dividerX = marginX + (contentW / 2);
            pdf.setDrawColor(...colors.line);
            pdf.line(dividerX, y + 34, dividerX, y + cardH - 10);
            const drawCol = (items, anchorX) => {
              let innerY = y + 42;
              items.forEach((item) => {
                const lines = split(item, leftW - 4, bodySize, '');
                setText(...colors.text);
                pdf.setFontSize(bodySize);
                pdf.text(lines, anchorX, innerY, { align:'right' });
                innerY += Math.max(lines.length, 1) * bodyLineH;
              });
            };
            drawCol(lineCols[0], pageW - marginX - 12);
            drawCol(lineCols[1], dividerX - 10);
            y += cardH + 6;
          });
          return y + 2;
        };
        ...
        const customerRows = this.buildOperationalFieldRows(primary, [
          'firstName','lastName','idNumber','birthDate','age','gender','maritalStatus','phone','email','city','street','houseNumber','houseNo','apartment','apartmentNo','zip','clinic','hmo','kupatHolim','shaban','shabanLevel','occupation',
          'heightCm','height','weightKg','weight','bmi','smokingStatus','smoking'
        ], { skipKeys:['cc','ho','externalPayer','healthDeclaration','operationalAgentNumbers','existingPolicies','newPolicies','policyPayers'] })
          .map(([label, value]) => [prepare(label), prepare(value)])
        ...
        insureds.forEach((ins, index) => {
          const insData = ins?.data && typeof ins.data === 'object' ? ins.data : {};
          const label = safeTrim(ins?.label) || `מבוטח ${index + 1}`;
          const policies = Array.isArray(insData?.existingPolicies) ? insData.existingPolicies : [];
          policies.forEach((policy, policyIndex) => {
            const statusMeta = this.getExistingPolicyStatusMeta(policy, insData);
            const detailLines = this.buildOperationalListLines(policy, [
              'policyNumber','monthlyPremium','premium','sumInsured','compensation','status','policyStatus','actionStatus','action','bankAgency','bankAgencyName','pledgeBankName'
            ], { skipKeys:['id','company','type'] }).map((line) => prepare(line)).filter(Boolean);
            if(statusMeta?.reason) detailLines.push(prepare(`סיבת סטטוס: ${statusMeta.reason}`));
            if(statusMeta?.partialDetails) detailLines.push(prepare(`פירוט נוסף: ${statusMeta.partialDetails}`));
            existingCards.push({
              title: `${label} · ${safeTrim(policy?.company) || 'חברה'} · ${safeTrim(policy?.type || policy?.product) || 'מוצר'}`,
              subtitle: `פוליסה קיימת ${policyIndex + 1}`,
              badge: statusMeta?.label || 'סטטוס לא זמין',
              badgeTone: statusMeta?.tone || 'neutral',
              lines: [
                prepare(`חברה: ${safeTrim(policy?.company) || '—'}`),
                prepare(`מוצר: ${safeTrim(policy?.type || policy?.product) || '—'}`),
                prepare(`פרמיה: ${safeTrim(policy?.monthlyPremium || policy?.premium) || '—'}`),
                ...detailLines
              ].filter(Boolean)
            });
          });
        ...
        const newCards = newPolicies.map((policy, policyIndex) => {
          const coverItems = Array.isArray(policy?.healthCovers) ? policy.healthCovers.filter(Boolean).map((item) => prepare(item)).filter(Boolean) : (Array.isArray(policy?.covers) ? policy.covers.filter(Boolean).map((item) => prepare(item)).filter(Boolean) : []);
          const pledgeBank = policy?.pledgeBank && typeof policy.pledgeBank === 'object' ? policy.pledgeBank : {};
          const lines = [
            ...this.buildOperationalListLines(policy, [
              'insuredMode','insuredId','premiumMonthly','premiumBefore','discountPct','startDate','sumInsured','compensation','coverage','coverages','paymentMethod','pledge','mortgageAmount','mortgageYears','mortgageAddress'
            ], { skipKeys:['company','type','healthCovers','covers','pledgeBank'] }).map((line) => prepare(line)).filter(Boolean),
            ...coverItems.map((item) => prepare(`כיסוי: ${item}`)),
            ...Object.entries(pledgeBank).map(([key, value]) => {
              const label = this.getOperationalReportFieldLabel(`pledgeBank.${key}`, key);
              return prepare(`${label}: ${value}`);
            }).filter(Boolean)
          ];
          return {
            title: `${safeTrim(policy?.company) || 'חברה'} · ${safeTrim(policy?.type || policy?.product) || 'מוצר'}`,
            subtitle: `מבוטח: ${prepare((() => {
              try{ return this.getNewPolicyInsuredLabel(payload, policy, insureds); }catch(_e){ return safeTrim(insureds?.[0]?.label) || 'מבוטח'; }
            })())}`,
            badge: policy?.pledge ? 'עם שיעבוד' : 'ללא שיעבוד',
            badgeTone: policy?.pledge ? 'warn' : 'success',
            lines: [
              prepare(`פרמיה חודשית: ${safeTrim(policy?.premiumMonthly || policy?.premium) || '—'}`),
              prepare(`תאריך תחילה: ${safeTrim(policy?.startDate) || '—'}`),
              ...lines
            ].filter(Boolean)
          };
        });

        const paymentRows = this.getOperationalPaymentRows(payload)
          .map(([label, value]) => [prepare(label), prepare(value)])
          .filter(([label, value]) => label && value);
        ...
        insureds.forEach((ins, index) => {
          ...
          questionList.forEach((item) => {
            ...
            const answerRaw = safeTrim(answer?.answer);
            if(!answerRaw) return;
            const details = answerRaw === 'yes' ? (safeTrim(this.summarizeHealthFields(answer?.fields || {})) || 'סומן כן ללא פירוט נוסף') : 'נענה לא';
            healthRows.push({
              insured: insLabel,
        ...
        let y = drawHeader('פתרון פיננסי ללקוח');
        y = sectionPill('פרטי לקוח', y);
        y = drawKvGrid(customerRows, y, { fieldsPerRow:2, labelW:70, fontSize:8.9, lineH:11.2 });
        y = sectionPill('פוליסות קיימות', y);
        y = drawPolicyCards(existingCards, y);
        y = sectionPill('פוליסות חדשות', y);
        y = drawPolicyCards(newCards, y);
        y = sectionPill('אמצעי תשלום', y);
        y = drawKvGrid(paymentRows, y, { fieldsPerRow:2, labelW:78, fontSize:8.8, lineH:11.1 });
        drawFooter(1);

        pdf.addPage('a4', 'p');
        y = drawHeader('הצהרת בריאות');
        y = sectionPill('הצהרת בריאות', y);

        const drawHealthTable = (rows, startY) => {
          let currentY = startY;
          const colQuestion = 228;
          const colInsured = 92;
          const colYes = 34;
          const colNo = 34;
          const colDetails = contentW - colQuestion - colInsured - colYes - colNo;
          const colXs = [
            pageW - marginX,
            pageW - marginX - colQuestion,
            pageW - marginX - colQuestion - colInsured,
            pageW - marginX - colQuestion - colInsured - colYes,
            pageW - marginX - colQuestion - colInsured - colYes - colNo,
            marginX
          ];
          const headers = [
            { text:'שאלה', x: colXs[0], w: colQuestion, align:'right' },
            { text:'מבוטח', x: colXs[1], w: colInsured, align:'right' },
            { text:'כן', x: colXs[2], w: colYes, align:'center' },
            { text:'לא', x: colXs[3], w: colNo, align:'center' },
            { text:'פירוט', x: colXs[4], w: colDetails, align:'right' }
          ];
          pdf.setDrawColor(...colors.line);
          pdf.setFillColor(...colors.soft2);
          pdf.rect(marginX, currentY, contentW, 24, 'FD');
          headers.forEach((head, idx) => {
            if(idx > 0) pdf.line(head.x, currentY, head.x, currentY + 24);
            setText(...colors.navy);
            pdf.setFontSize(9.1);
            const tx = head.align === 'center' ? head.x - (head.w / 2) : head.x - 8;
            pdf.text(prepare(head.text), tx, currentY + 15, { align: head.align });
          });
          currentY += 24;
          const dataRows = rows.length ? rows : [{ insured:'—', question:'לא נמצאו תשובות הצהרת בריאות להצגה', yes:false, no:false, details:'המערכת לא מצאה מידע נוסף' }];
          dataRows.forEach((row, idx) => {
            const qLines = split(row.question, colQuestion - 12, 8.7, '—');
            const insLines = split(row.insured, colInsured - 12, 8.7, '—');
            const dLines = split(row.details, colDetails - 12, 8.7, '—');
            const linesCount = Math.max(qLines.length, insLines.length, dLines.length, 1);
            const rowH = Math.max(26, 10 + (linesCount * 10));
            pdf.setDrawColor(...colors.line);
            pdf.setFillColor(...(idx % 2 === 0 ? [255,255,255] : [250,252,255]));
            pdf.rect(marginX, currentY, contentW, rowH, 'FD');
            headers.slice(1).forEach((head) => pdf.line(head.x, currentY, head.x, currentY + rowH));
            setText(...colors.text);
            pdf.setFontSize(8.7);
            pdf.text(qLines, colXs[0] - 8, currentY + 14, { align:'right' });
            pdf.text(insLines, colXs[1] - 8, currentY + 14, { align:'right' });
            pdf.text(dLines, colXs[4] - 8, currentY + 14, { align:'right' });
            setText(...colors.navy);
            pdf.setFontSize(10.2);
            pdf.text(row.yes ? '✓' : '', colXs[2] - (colYes / 2), currentY + 15, { align:'center' });
            pdf.text(row.no ? '✓' : '', colXs[3] - (colNo / 2), currentY + 15, { align:'center' });
            currentY += rowH;
          });
          return currentY + 10;
        };

        y = drawHealthTable(healthRows, y);
        drawFooter(2);
        pdf.save(this.getOperationalPdfFileName(payload));
      }catch(err){
