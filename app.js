...
(() => {
  ...
  const BUILD = "20260406-dashboard-kpi-role-visibility-v43";
...
this.applyRoleUI();
  ...
  const DashboardUI = {
    ...
    renderEmpty(){
      ...
      this.els.root.innerHTML = `
        <div class="dashboardHeroPlain">
          <div class="dashboardHeroPlain__eyebrow">ביצועי החודש - ${escapeHtml(monthLabel)}</div>
        </div>
