  ...
  const ProposalFormUI = {
    ...
    async openPreview(){
      try{
        ...
        this.setStatus('לא ניתן היה ליצור תצוגה מקדימה של טופס הפניקס כרגע.', true);
        alert('לא ניתן היה ליצור תצוגה מקדימה של טופס הפניקס כרגע.');
      }
    },
    ...
    async downloadPdf(){
      try{
        ...
        this.setStatus('לא ניתן היה להפיק כעת את טופס הפניקס המקורי.', true);
        alert('לא ניתן היה להפיק כעת את טופס הפניקס המקורי.');
      }
    }
  };
