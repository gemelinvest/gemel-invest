...
const SystemRepairUI = {
    ...
    setBusy(flag){
      ...
      if(this.els.confirm) this.els.confirm.textContent = flag ? "מבצע טיפול..." : "אישור והפעל טיפול";
    },
    ...
    async run(){
      ...
      try {
        ...
        if(syncResult.ok || syncResult.skipped){
          this.setStatus("הטיפול הושלם. המערכת שוחררה, נבדקה ורועננה בהצלחה.", "is-ok");
        } else {
        ...
        this.rerenderCurrentView(currentView);
        this.updateProgress(3, 100);
        this.setStatus("בוצע טיפול חירום מקומי. אם התקלה חוזרת, מומלץ לבצע רענון מלא למערכת.", "is-err");
      } finally {
        this.setBusy(false);
      }
    }
