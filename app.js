...
(() => {
  ...
  const BUILD = "20260401-mfa-premium-v21";
...
init(){
    ...
    renderBody(){
      ...
      const addBtn = "";
      const summaryHeaderBrand = (this.step === 7 || this.step === 9) ? `
          <div class="lcSummaryHeaderBrand" aria-hidden="true">
            <img class="lcSummaryHeaderBrand__img" src="./insuregen-badge.png" alt="" loading="eager" decoding="async" />
          </div>` : "";
      const head = (this.step === 1 || this.step === 5) ? "" : (isCaseLevel ? `<div class="lcWSection lcSummaryHeaderSection">
