...
(() => {
  ...
  const BUILD = "20260406-v57-dashboard-kpi-glow";
            ...
            <div class="bankGoal__shell">
              <div class="bankGoal__header">
                <div class="bankGoal__titleWrap">
                  ...
                  <div class="bankGoal__percentSub">${metrics.targetValue > 0 ? `התקדמות חודשית · ${escapeHtml(metrics.monthLabel)}` : `ממתין להגדרת יעד`}</div>
                </div>
                <div class="bankGoal__progressHero">
                  <div class="bankGoal__percent">${escapeHtml(this.formatPct(metrics.targetPct))}</div>
                  <div class="bankGoal__percentLabel">עמידה ביעד</div>
                </div>
              </div>
              ...
              <div class="bankGoal__topStats">
                ...
                <div class="bankGoal__topStat">
                  <span>פער</span>
                  <strong>${escapeHtml(this.formatMoney(metrics.targetRemaining || 0))}</strong>
                  <small>${metrics.targetRemaining > 0 ? `נשאר להשלים` : `היעד הושלם`}</small>
                </div>
              ...
              <div class="bankGoal__progressWrap">
                ...
                <div class="bankGoal__metaRow">
                  <span><b>${metrics.targetValue > 0 ? escapeHtml(this.formatMoney(metrics.targetValue)) : '₪0'}</b> יעד חודשי</span>
