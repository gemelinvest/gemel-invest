...
(() => {
  ...
  const BUILD = "20260405-dashboard-agent-kpis-dashboard-only-v39";
      ...
      this.els.root.innerHTML = `
        <div class="card dashboardHeroCard">
          <div class="dashboardHeroCard__body">
            <div>
              <div class="dashboardHeroCard__eyebrow">GEMEL INVEST</div>
              <div class="dashboardHeroCard__title">דשבורד אישי</div>
              <div class="dashboardHeroCard__sub">ברגע שיישמרו לקוחות ופוליסות החודש, המדדים יופיעו כאן אוטומטית.</div>
            </div>
          </div>
        </div>
        <div class="emptyState">
          ...
          <div class="emptyState__text">המדדים נבנים לפי לקוחות של הנציג מהחודש הנוכחי, כולל פוליסות חדשות ומינויי סוכן.</div>
        </div>`;
    },
