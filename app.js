...
(() => {
  ...
  const BUILD = "20260406-wizard-email-validation-v47";
      ...
      this.els.root.innerHTML = `
        <section class="bankDash">
          ...
          <article class="bankGoal card bankGoal--${metrics.targetTone}">
            <div class="bankGoal__head">
              <div class="bankGoal__title">ביצועים מול יעד</div>
              <div class="bankGoal__sub">היעד נמשך מתוך ניהול משתמשים עבור המשתמש המחובר</div>
            </div>
            <div class="bankGoal__stats">
              <div class="bankGoal__stat">
                <span>יעד חודשי</span>
                <strong>${metrics.targetValue > 0 ? escapeHtml(this.formatMoney(metrics.targetValue)) : '—'}</strong>
              </div>
              <div class="bankGoal__stat">
              ...
              <div class="bankGoal__stat">
                <span>נותר ליעד</span>
                <strong>${metrics.targetValue > 0 ? escapeHtml(this.formatMoney(metrics.targetRemaining)) : 'טרם הוגדר יעד'}</strong>
              </div>
            </div>
            <div class="bankGoal__progressTrack"><span style="width:${Math.min(metrics.targetPct, 100)}%"></span></div>
            <div class="bankGoal__foot">${metrics.targetValue > 0 ? `היעד מנוהל במסך ניהול המשתמשים` : `טרם הוגדר יעד חודשי על ידי מנהל המערכת`}</div>
          </article>
