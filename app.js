...
(() => {
  ...
  const BUILD = "20260324-operational-report-pdf-center-fit-v3";
...
// ---------- Step 6 ----------
    ...
    async exportOperationalPdf(payloadOverride, sourceBtn){
      ...
      try{
        ...
        const exportPageWidth = 760;
        const exportOuterWidth = 794;
        ...
        exportFrame.style.padding = '16px 17px';
        ...
        clonedDoc.style.margin = '0';
        clonedDoc.style.width = '980px';
        clonedDoc.style.maxWidth = '980px';
        ...
        if(fitScale < 0.999){
          ...
          exportFrame.style.minHeight = Math.ceil((clonedDoc.scrollHeight || clonedDoc.offsetHeight || 0) * fitScale) + 'px';
        }else{
          clonedDoc.style.width = '100%';
          clonedDoc.style.maxWidth = exportPageWidth + 'px';
          exportFrame.style.minHeight = '0';
        }
        ...
        const worker = html2pdfFactory().set({
          ...
          html2canvas: {
            ...
            windowHeight: Math.max(target.scrollHeight || 1400, 1400),
            logging: false,
