...
(() => {
  ...
  const BUILD = "20260324-operational-report-live-export-fix-v2";
...
// ---------- Step 6 ----------
    ...
    async exportOperationalPdf(payloadOverride, sourceBtn){
      ...
      try{
        ...
        const clonedButtons = host.querySelectorAll ? host.querySelectorAll('button') : [];
        ...
        const worker = html2pdfFactory().set({
          ...
          html2canvas: {
            ...
            scrollY: 0,
            scrollX: 0,
            windowWidth: Math.max(target.scrollWidth || 1120, 1120),
            windowHeight: Math.max(target.scrollHeight || 1600, 1600),
            logging: false,
