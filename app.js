...
(() => {
  ...
  const BUILD = "20260406-v55-new-customer-list";
      ...
      this.els.root.innerHTML = `
        <section class="bankDash bankDash--empty">
          <div class="bankDash__hero card">
            <div class="bankDash__heroTitle">הביצועים שלי - ${escapeHtml(this.formatMonthTitle())}</div>
        ...
        <section class="bankDash">
          <div class="bankDash__hero card">
            <div class="bankDash__heroTop">
              <div>
                <div class="bankDash__heroTitle">הביצועים שלי - ${escapeHtml(metrics.monthLabel)}</div>
              </div>
