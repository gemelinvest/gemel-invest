                ...
                <div class="customerStatCard__content customerStatCard__content--premium">
                  <div class="customerStatCard__premiumRows">
                    <div class="customerStatCard__premiumRow">
                      ...
                      <strong class="customerStatCard__miniValue" data-animate-number="${escapeHtml(String(this.asNumber(card.beforeValue)))}">${escapeHtml(card.beforeValue)}</strong>
                    </div>
                    <div class="customerStatCard__premiumRow customerStatCard__premiumRow--final">
                      ...
                      <strong class="customerStatCard__miniValue customerStatCard__miniValue--final" data-animate-number="${escapeHtml(String(this.asNumber(card.afterValue)))}">${escapeHtml(card.afterValue)}</strong>
                    </div>
                  </div>
                  <div class="customerStatCard__label">${escapeHtml(card.label)}</div>
                  <div class="customerStatCard__sub">${escapeHtml(card.sub)}</div>
                  <div class="customerStatCard__savings">חיסכון כולל: <span data-animate-number="${escapeHtml(String(this.asNumber(card.savingsValue)))}">${escapeHtml(card.savingsValue)}</span></div>
                </div>
              </div>`;
            }
            return `
