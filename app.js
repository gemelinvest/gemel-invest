...
const SystemRepairUI = {
  ...
  const InvestoUI = {
    ...
    fabWasDragged: false,
    history: [],
    greetedForSession: false,
    medicalTopics: {
      'סוכרת': {
        type: 'condition',
        aliases: ['סוכרת','סוכרת סוג 2','סכרת','diabetes','dm'],
        title: 'סוכרת',
        summary: 'מחלה כרונית שבה הגוף לא מנצל נכון אינסולין או לא מייצר מספיק אינסולין, ולכן רמות הסוכר בדם עולות.',
        bullets: ['מעקב חשוב: HbA1c, סוכר בצום, סיבוכים באיברי מטרה ותרופות קבועות.', 'שאלות חיתום נפוצות: סוג הסוכרת, שנת אבחנה, איזון, טיפול, חלבון בשתן ופגיעה באיברי מטרה.'],
        meds: 'מטפורמין, אינסולין, Ozempic ותרופות ממשפחת GLP-1/SGLT2 לפי רופא.',
        caution: 'אין להמליץ על טיפול אישי או מינון בלי רופא.'
      },
      'לחץ דם': {
        type: 'condition',
        aliases: ['לחץ דם','יתר לחץ דם','לחץדם','blood pressure'],
        title: 'יתר לחץ דם',
        summary: 'מצב שבו לחץ הדם גבוה לאורך זמן ועלול להעלות סיכון ללב, מוח, כליות וכלי דם.',
        bullets: ['בחיתום בדרך כלל חשוב ערך ממוצע/אחרון מהשנה האחרונה וטיפול קבוע.', 'תשובה טובה לנציג כוללת: ערכים אחרונים, האם מאוזן, תרופות, סיבוכים או אשפוזים.'],
        meds: 'לרוב רואים אמלודיפין, לוסרטן, ולסרטן, אנלדקס או תרופות דומות לפי רופא.',
        caution: 'במקרה של כאב חזה, קוצר נשימה או לחץ דם קיצוני - זה לא לצ׳אט אלא לבירור רפואי.'
      },
      'כולסטרול': {
        type: 'condition',
        aliases: ['כולסטרול','יתר שומנים','שומנים בדם','טריגליצרידים','hyperlipidemia'],
        title: 'יתר שומנים בדם',
        summary: 'מצב של עלייה בכולסטרול ו/או טריגליצרידים, שיכול להעלות סיכון לבבי וכלי דם.',
        bullets: ['בחיתום בודקים בדרך כלל ערכי כולסטרול/טריגליצרידים אחרונים מהשנה האחרונה.', 'חשוב לציין האם יש רקע לבבי, עישון, יתר לחץ דם או סוכרת.'],
        meds: 'לרוב סטטינים כמו אטורבסטטין או רוזובסטטין לפי רופא.',
        caution: 'לא כל ערך גבוה דורש אותו טיפול; צריך הקשר רפואי מלא.'
      },
      'סרטן': {
        type: 'condition',
        aliases: ['סרטן','גידול','אונקולוגי','cancer'],
        title: 'סרטן / גידול',
        summary: 'קבוצה רחבה של מחלות שבהן יש התרבות לא תקינה של תאים. בחיתום חשובים סוג הגידול, stage/grade, טיפול ומועד סיום טיפול.',
        bullets: ['בדרך כלל יש הבדל מהותי בין חיתום בתוך 10 שנים אחרונות לבין מעל 10 שנים.', 'נציג צריך לציין אבחנה מדויקת, מועד גילוי, טיפולים, מצב עדכני והאם הייתה חזרה של המחלה.'],
        meds: 'הטיפול משתנה מאוד בין סוגי הסרטן ולכן לא נותנים כאן טיפול אחיד.',
        caution: 'אין להשתמש בתשובה כתחליף לאונקולוג או חתם החברה.'
      },
      'מחלת לב': {
        type: 'condition',
        aliases: ['מחלת לב','לב','אוטם','צנתור','הפרעת קצב','מסתמים'],
        title: 'מחלות לב',
        summary: 'קבוצה של מצבים לבביים כמו מחלת לב איסכמית, אוטם, צנתור, הפרעות קצב או בעיות מסתמים.',
        bullets: ['בחיתום חשוב תיעוד קרדיולוג, אבחנה מדויקת, חומרה ובדיקות שבוצעו כמו אקו/מיפוי/מאמץ.', 'בנוסף חשוב לציין אם יש מגבלה תפקודית, תרופות קבועות ואשפוזים.'],
        meds: 'זה תלוי באבחנה: לעיתים אספירין, סטטין, חוסם בטא, ACE/ARB ועוד - לפי קרדיולוג.',
        caution: 'כאב חזה, קוצר נשימה חריג או עילפון דורשים בירור רפואי דחוף.'
      },
      'אסתמה': {
        type: 'condition',
        aliases: ['אסתמה','אסטמה','asthma'],
        title: 'אסתמה',
        summary: 'מחלה דלקתית כרונית של דרכי האוויר שיכולה לגרום לצפצופים, שיעול וקוצר נשימה.',
        bullets: ['בבירור חיתומי כדאי לציין חומרה, שימוש במשאפים, תדירות התקפים ואשפוזים אם היו.', 'גם עישון או מחלות ריאה נוספות חשובים לתמונה מלאה.'],
        meds: 'משאפי סטרואידים, ונטולין/רלבר/סימביקורט - לפי רופא.',
        caution: 'קוצר נשימה משמעותי או חוסר תגובה למשאף דורשים בירור רפואי.'
      },
      'חרדה': {
        type: 'condition',
        aliases: ['חרדה','פאניקה','anxiety'],
        title: 'חרדה',
        summary: 'מצב נפשי שיכול להתבטא במתח, דופק מהיר, מחשבות דאגה ולעיתים התקפי חרדה.',
        bullets: ['בחיתום חשוב אם יש טיפול תרופתי, טיפול נפשי, אשפוזים, חופשת מחלה או ירידה תפקודית.', 'מועדים, אבחנה רשמית והאם יש יציבות חשובים מאוד.'],
        meds: 'לעיתים רואים סרטרלין, ציפרלקס או תרופות אחרות לפי פסיכיאטר/רופא.',
        caution: 'אם יש מחשבות אובדניות או החמרה חריפה - יש לפנות מיד לאיש מקצוע או מוקד חירום.'
      }
    },
    drugTopics: {
      'מטפורמין': {
        aliases: ['מטפורמין','metformin','גלוקומין','glucophage'],
        title: 'מטפורמין',
        summary: 'תרופה נפוצה לטיפול בסוכרת סוג 2, שמסייעת לשפר איזון סוכר בעיקר דרך השפעה על הכבד ורגישות לאינסולין.',
        bullets: ['היא לא מחליפה תזונה/מעקב רפואי.', 'בחיתום עצם נטילת התרופה מרמזת על סוכרת/טרום סוכרת ולכן שואלים על איזון ו-A1c.'],
        caution: 'אין לתת מינון אישי בצ׳אט.'
      },
      'אוזמפיק': {
        aliases: ['אוזמפיק','ozempic','סמגלוטייד','semaglutide'],
        title: 'Ozempic / סמגלוטייד',
        summary: 'תרופה ממשפחת GLP-1 שנועדה בעיקר לסוכרת סוג 2, ולעיתים קשורה גם לירידה במשקל לפי אינדיקציה רפואית.',
        bullets: ['חשוב להבין אם השימוש הוא עבור סוכרת, השמנה או שניהם.', 'בחיתום זה מעלה לרוב שאלות על סוכרת, BMI ומחלות רקע נלוות.'],
        caution: 'אין לשנות מינון או להפסיק טיפול בלי רופא.'
      },
      'אינסולין': {
        aliases: ['אינסולין','insulin'],
        title: 'אינסולין',
        summary: 'הורמון/טיפול שנועד להוריד סוכר בדם, נפוץ בסוכרת סוג 1 וגם בחלק ממקרי סוכרת סוג 2.',
        bullets: ['בשאלת חיתום חשוב אם מדובר בסוג 1 או סוג 2, מתי התחיל טיפול ואיך האיזון.', 'לעיתים טיפול באינסולין מצביע על חומרה או משך מחלה משמעותי יותר.'],
        caution: 'סיכון להיפוגליקמיה מחייב מעקב רפואי צמוד.'
      },
      'לוסרטן': {
        aliases: ['לוסרטן','losartan','קוזאר'],
        title: 'לוסרטן',
        summary: 'תרופה שכיחה ליתר לחץ דם ולעיתים גם להגנה כלייתית במצבים מסוימים.',
        bullets: ['עצם התרופה לא מספיקה; חשוב הערכים בפועל והאם יש מחלות רקע.', 'לעיתים קשורה גם למחלת כליה או סוכרת.'],
        caution: 'לא נותנים מינון או שינוי טיפול בצ׳אט.'
      },
      'אטורבסטטין': {
        aliases: ['אטורבסטטין','atorvastatin','ליפיטור','סטטין'],
        title: 'אטורבסטטין / סטטין',
        summary: 'תרופה להורדת כולסטרול, בעיקר LDL, ולהפחתת סיכון קרדיווסקולרי במטופלים מתאימים.',
        bullets: ['בבירור חיתומי חשוב להבין אם התרופה ניתנה רק על רקע כולסטרול גבוה או גם אחרי אירוע לבבי.', 'יש משמעות לערכי שומנים אחרונים ולרקע נוסף.'],
        caution: 'כאב שרירים, צהבת או תופעות חריגות מחייבים רופא.'
      },
      'לבותירוקסין': {
        aliases: ['לבותירוקסין','levothyroxine','אלטרוקסין','יוטירוקס'],
        title: 'לבותירוקסין / אלטרוקסין',
        summary: 'תרופה להשלמת הורמון בלוטת התריס במצבי תת-פעילות של בלוטת התריס.',
        bullets: ['בדרך כלל חיתום ירצה לדעת מה האבחנה, האם מאוזן ומה ערכי TSH אחרונים.', 'אם מדובר במעקב יציב ללא סיבוכים, לעיתים זה נתפס קל יחסית.'],
        caution: 'לא לשנות מינון ללא בדיקות והוראת רופא.'
      },
      'סרטרלין': {
        aliases: ['סרטרלין','sertraline','לוסטרל','zoloft'],
        title: 'סרטרלין',
        summary: 'תרופה מקבוצת SSRI שניתנת למצבי חרדה, דיכאון ולעיתים OCD/PTSD לפי רופא.',
        bullets: ['בחיתום חשוב להבין על איזו אבחנה ניתנה, מה היציבות התפקודית והאם היו אשפוזים/חופשות מחלה.', 'לא נכון להסיק לבד מהתרופה את חומרת המצב.'],
        caution: 'אין לתת הנחיית התחלה/הפסקה של טיפול ללא גורם מטפל.'
      }
    },
    underwritingStructured: {
      'פניקס': {
        conditions: {
          'סוכרת': 'שאלון סוכרת מלא. לפי הטקסט שהוטמע: סכום ריסק עד ₪750,000 ואכ"ע עד ₪7,000 - שאלון סוכרת מלא. מעל זה יש דרישת תיעוד מרופא מטפל עם סוג הסוכרת, מועד אבחנה, פגיעה באיברי מטרה, חלבון בשתן ו-HbA1c.',
          'לחץ דם': 'בטקסט שהוטמע עבור יתר לחץ דם נדרש בדרך כלל ערך לחץ דם ממוצע/אחרון מהשנה האחרונה.',
          'כולסטרול': 'בטקסט שהוטמע עבור יתר שומנים/כולסטרול נדרשים ערכי כולסטרול ו/או טריגליצרידים ממוצעים/אחרונים מהשנה האחרונה.',
          'מחלת לב': 'הטקסט שהוטמע דורש תיעוד קרדיולוג: אבחנה מדויקת, חומרת מחלה ובדיקות שבוצעו כגון צנתור / אקו / מיפוי / בדיקת מאמץ.',
          'סרטן': 'לפי הטקסט: בתוך 10 השנים האחרונות נדרש בדרך כלל תיעוד אונקולוג עם אבחנה מדויקת, מועד גילוי, טיפול, מועד סיום, Stage/Grade ומצב עדכני. מעל 10 שנים יש יותר מקום להסתמך על הצהרת מועמד עם פירוט.',
          'ביופסיה': 'אם מדובר ב-3 החודשים האחרונים - דרישת תוצאה/דוח היסטולוגי או התייחסות רופא. מעל 3 חודשים: בשד/בלוטת תריס/עור/מעי גס חשוב לציין אם שפיר או ממאיר; באיברים אחרים לרוב נדרש תיעוד.',
          'אנמיה': 'הטקסט מתייחס להמוגלובין אחרון ולבירור/תוצאות, עם הבחנה בין אנמיה מתחת לגיל 50 לבין גיל 50 ומעלה.',
          'קרישיות': 'נדרש פירוט אבחנה, טיפול, האם היה אירוע קריש דם, מועד ומיקום בגוף, והאם נותרו סיבוכים.',
          'כליות': 'נדרש לרוב תיעוד נפרולוג/אורולוג כולל תפקודי כליות, בדיקות שתן והתייחסות למחלת כליות / דם או חלבון בשתן.'
        }
      },
      'איילון': {
        conditions: {},
        generic: 'הקובץ שהוטמע באיילון מתמקד בתקרות לבדיקות רפואיות לפי גיל וסכום ביטוח, למשל בריסק ובאכ"ע. לדוגמה: בגיל 0-50 בריסק עד ₪3,500,000 ללא בדיקה, עד ₪5,500,000 בדיקה רגילה, ומעל זה בדיקה מורחבת; באכ"ע 20-50 עד ₪20,000 ללא בדיקה, עד ₪40,000 בדיקה רגילה, ומעל זה מורחבת + ארגומטריה.'
      },
      'הכשרה': {
        conditions: {},
        generic: 'מהטקסט שהוטמע בהכשרה עולה מבנה דומה של תקרות בדיקות לפי קבוצות גיל וסכומי ביטוח, למשל גיל 18-50: עד ₪3,500,000 הצהרת בריאות מלאה, מ-₪3,500,001 עד ₪4,999,999 בדיקה רפואית רגילה, ומ-₪5,000,000 בדיקה מורחבת + חיתום פיננסי.'
      },
      'מנורה': {
        conditions: {},
        generic: 'הטקסט שהוטמע במנורה עוסק בעיקר במסמכים ובדיקות נדרשים לסכומי ביטוח חיים ואכ"ע לפי גיל. לדוגמה בגיל 20-45: עד ₪3,675,000 / אכ"ע עד ₪18,000 - הצהרת בריאות מלאה; עד ₪6,000,000 / אכ"ע עד ₪35,000 - בדיקה רגילה; מעל זה - בדיקה מורחבת.'
      },
      'הראל': {
        conditions: {},
        generic: 'בגרסה הנוכחית הוטמעו מהראל בעיקר עמודי דרישות פיננסיות/בדיקות לפי סכומי ביטוח, ולא זוהה עדיין כלל רפואי מפורט למחלות ספציפיות.'
      },
      'מגדל': {
        conditions: {},
        generic: 'קובץ מגדל זוהה כסרוק חלקית, ולכן בגרסה הזאת אין עדיין כלל רפואי מפורט מובנה לשליפה אוטומטית.'
      },
      'כלל': {
        conditions: {},
        generic: 'קובץ כלל זוהה כסרוק חלקית, ולכן בגרסה הזאת אין עדיין כלל רפואי מפורט מובנה לשליפה אוטומטית.'
      }
    },
    companyDocs: {
      'פניקס': 'דגשים בחיתום ונתונים הכרחיים לחיתום. דוגמאות בולטות: בסוכרת - שאלון סוכרת מלא ובסכומים גבוהים יותר תיעוד רופא מטפל עם סוג סוכרת, מועד אבחנה, פגיעה באיברי מטרה, חלבון בשתן ו-HbA1c. ביתר לחץ דם ושומנים - ערכים אחרונים/ממוצעים מהשנה האחרונה. במחלת לב - תיעוד קרדיולוג עם בדיקות שבוצעו. בסרטן - פירוט אונקולוגי ומועדי טיפול. בביופסיה - דוח היסטולוגי/תיעוד רופא לפי איבר ומועד.',
      'איילון': 'טבלת תקרות לבדיקות רפואיות. ריסק: גיל 0-50 עד 3,500,000 ללא בדיקה, עד 5,500,000 בדיקה רגילה ומעל זה מורחבת. גיל 51-55 עד 2,500,001 ללא בדיקה, עד 4,000,000 בדיקה רגילה ומעל זה מורחבת. באכ"ע קיימות מדרגות 20,000/40,000 לגיל 20-50, ובהמשך יורדות בגילאים מבוגרים יותר.',
      'הכשרה': 'דרישות חיתום בביטוח חיים לפי גיל ותקרת סכומי ביטוח. גיל 18-50: עד 3,500,000 הצהרת בריאות מלאה ומפורטת; מ-3,500,001 עד 4,999,999 בדיקה רגילה; מ-5,000,000 בדיקה מורחבת ונדרש חיתום פיננסי. בגיל 51-55 התקרות נמוכות יותר.',
      'מנורה': 'טבלת מסמכים רפואיים נדרשים ובדיקות לסכומי ביטוח חיים. לדוגמה גיל 20-45: עד 3,675,000 / אכ"ע עד 18,000 הצהרת בריאות מלאה; עד 6,000,000 / אכ"ע עד 35,000 בדיקה רגילה; מעל זה בדיקה מורחבת. בגיל 46-50 וב-51-55 התקרות יורדות.',
      'הראל': 'נשלף חלקית. בגרסה הזו זוהו בעיקר עמודי סכומי ביטוח ודרישות פיננסיות/הצהרות ולא טבלת אבחנות רפואיות מפורטת.',
      'מגדל': 'קובץ סרוק חלקית ולכן לא נשלף כלל רפואי מפורט זמין למנוע החיפוש המקומי.',
      'כלל': 'קובץ סרוק חלקית ולכן לא נשלף כלל רפואי מפורט זמין למנוע החיפוש המקומי.'
    },
    companyAliases: {
      'פניקס': ['פניקס','הפניקס','phoenix'],
      'הראל': ['הראל','harel'],
      'כלל': ['כלל','clal'],
      'מגדל': ['מגדל','migdal'],
      'מנורה': ['מנורה','menora'],
    ...
    init(){
      this.els = {
        fab: $('#investoFab'),
        fabBadge: $('#investoFabBadge'),
        window: $('#investoWindow'),
        close: $('#investoClose'),
        minimize: $('#investoMinimize'),
        dragHandle: $('#investoDragHandle'),
        messages: $('#investoMessages'),
        input: $('#investoInput'),
        send: $('#investoSend'),
        typing: $('#investoTyping'),
        quick: $('#investoQuick'),
        agentLine: $('#investoAgentLine')
      };
      if(!this.els.fab || !this.els.window) return;
      this.ready = true;
      on(this.els.fab, 'click', (ev) => {
      ...
      $$('[data-investo-q]', this.els.quick).forEach((btn) => on(btn, 'click', () => {
        const q = safeTrim(btn.dataset.investoQ);
        if(!q) return;
    ...
    agentName(){
      return safeTrim(Auth?.current?.name) || 'נציג';
    },
    syncVisibility(){
      const canShow = !!Auth.current && !document.body.classList.contains('lcAuthLock');
      if(!canShow){
        this.hideFab();
        this.closeWindow(false, true);
        return;
    ...
    showFab(){
      ...
      this.els.fab.classList.remove('is-hidden');
      if(this.hasSavedFabPosition()) this.restoreFabPosition();
      else this.captureFabPosition(false);
    },
    hideFab(){ this.els.fab?.classList.add('is-hidden'); },
    openWindow(){
      if(!this.ready) return;
      this.refreshIdentity();
      this.els.window.classList.remove('is-hidden');
      ...
      this.hideFab();
      if(!this.greetedForSession){
        this.greetedForSession = true;
        this.pushBotMessage(this.buildWelcomeHtml());
      }
      setTimeout(() => this.els.input?.focus?.(), 50);
    },
    closeWindow(showFab=true, silent=false){
      if(!this.ready) return;
      this.els.window.classList.add('is-hidden');
      this.els.window.setAttribute('aria-hidden', 'true');
      this.hideTyping();
      if(showFab && !document.body.classList.contains('lcAuthLock')) this.showFab();
      if(!silent) this.refreshSendButton();
    },
    toggleWindow(){
      if(this.els.window.classList.contains('is-hidden')) this.openWindow();
      else this.closeWindow();
    },
    buildWelcomeHtml(){
      const name = this.escapeHtml(this.agentName());
      return `<strong>שלום ${name}</strong><br>אני <strong>investo</strong> - העוזר החכם שלך.<br><br><span class="investoSectionTitle">מה אפשר לשאול אותי</span><ul class="investoList"><li>מחלות: מה זה סוכרת / לחץ דם / סרטן</li><li>תרופות: מטפורמין, אוזמפיק, אינסולין ועוד</li><li>חיתום: לפי כל החברות כברירת מחדל, או סינון לחברה ספציפית</li></ul>`;
    },
    refreshIdentity(){
      if(this.els.agentLine) this.els.agentLine.textContent = `מזהה את הנציג: ${this.agentName()}`;
    },
    historyKey(){
      return `${INVESTO_FAB_STORAGE_KEY}__HISTORY__${safeTrim(Auth?.current?.name) || 'guest'}`;
    },
    fabStorageKey(){
      return `${INVESTO_FAB_STORAGE_KEY}__POS__${safeTrim(Auth?.current?.name) || 'guest'}`;
    },
    loadHistory(){
      try {
      ...
      if(!this.history.length){
        this.history = [{ role:'bot', html:this.buildWelcomeHtml() }];
        this.saveHistory();
      }
    },
    saveHistory(){
      try { localStorage.setItem(this.historyKey(), JSON.stringify(this.history.slice(-24))); } catch(_e) {}
    },
    renderHistory(){
      if(!this.els.messages) return;
      this.els.messages.innerHTML = '';
      this.history.forEach((entry) => {
        this.appendMessageNode(entry.role, entry.html || this.escapeHtml(entry.text || ''));
      });
      this.scrollMessages();
    },
    appendMessageNode(role, html){
      const wrap = document.createElement('article');
      wrap.className = `investoMsg investoMsg--${role === 'user' ? 'user' : 'bot'}`;
      wrap.innerHTML = `<div class="investoMsg__bubble">${html}</div>`;
      this.els.messages.appendChild(wrap);
    },
    pushUserMessage(text){
      const html = this.escapeHtml(text).replace(/\n/g, '<br>');
      this.history.push({ role:'user', text, html });
      this.appendMessageNode('user', html);
      this.saveHistory();
      this.scrollMessages();
    },
    pushBotMessage(html){
      this.history.push({ role:'bot', html });
      this.appendMessageNode('bot', html);
      this.saveHistory();
      this.scrollMessages();
    },
    scrollMessages(){
      if(this.els.messages) this.els.messages.scrollTop = this.els.messages.scrollHeight + 120;
    },
    autoGrowInput(){
      const el = this.els.input;
      if(!el) return;
      el.style.height = 'auto';
      el.style.height = Math.min(140, Math.max(54, el.scrollHeight)) + 'px';
    },
    refreshSendButton(){
      if(this.els.send) this.els.send.disabled = !safeTrim(this.els.input?.value);
    },
    showTyping(){ this.els.typing?.classList.remove('is-hidden'); this.scrollMessages(); },
    hideTyping(){ this.els.typing?.classList.add('is-hidden'); },
    async sendMessage(){
      const text = safeTrim(this.els.input?.value);
      if(!text) return;
    ...
    detectCompanyNames(query){
      const q = this.normalize(query);
      const found = [];
      Object.entries(this.companyAliases).forEach(([name, aliases]) => {
        if(aliases.some((alias) => q.includes(this.normalize(alias)))) found.push(name);
      });
      return found;
    },
    detectMedicalTopic(query){
      const q = this.normalize(query);
      for(const topic of Object.values(this.medicalTopics)){
        if(topic.aliases.some((alias) => q.includes(this.normalize(alias)))) return topic;
      }
      for(const topic of Object.values(this.drugTopics)){
        if(topic.aliases.some((alias) => q.includes(this.normalize(alias)))) return topic;
      }
      return null;
    },
    detectConditionKey(query){
      const q = this.normalize(query);
      const map = {
        'סוכרת':['סוכרת','סכרת','diabetes'],
        'לחץ דם':['לחץ דם','יתר לחץ דם'],
        'כולסטרול':['כולסטרול','שומנים בדם','טריגליצרידים'],
        'מחלת לב':['מחלת לב','לב','אוטם','צנתור','הפרעת קצב','מסתמים'],
        'סרטן':['סרטן','גידול','אונקולוג'],
        'ביופסיה':['ביופסיה'],
        'אנמיה':['אנמיה'],
        'קרישיות':['קרישיות','קריש דם'],
        'כליות':['כליות','דם בשתן','חלבון בשתן'],
      };
      for(const [key, aliases] of Object.entries(map)){
        if(aliases.some((alias) => q.includes(this.normalize(alias)))) return key;
      }
      return '';
    },
    isMedicalIntent(query){
      const q = this.normalize(query);
      return ['מחלה','תרופה','כדור','טיפול','מה זה','מהי','תסמינים','סימפטומים','תרופות','medicine','drug'].some((w) => q.includes(this.normalize(w))) || !!this.detectMedicalTopic(query);
    },
    isUnderwritingIntent(query){
      const q = this.normalize(query);
      return ['חיתום','החרגה','תוספת','בדיקה','בדיקות','מסמכים','תיעוד','ריסק','אכע','מרפא','חברה','חברת','פוליסה','ביטוח'].some((w) => q.includes(this.normalize(w))) || this.detectCompanyNames(query).length > 0;
    },
    answer(query){
      const q = safeTrim(query);
      const qNorm = this.normalize(q);
      if(!qNorm) return 'לא נקלטה שאלה.';
      if(['שלום','היי','הי','מי אתה','מה אתה יודע','איך אתה עובד'].some((w) => qNorm === this.normalize(w) || qNorm.includes(this.normalize(w)))){
        return this.buildWelcomeHtml();
      }
      if(qNorm.includes('מה השם שלי') || qNorm.includes('איך קוראים לי') || qNorm.includes('מי מחובר')){
        return `<strong>אתה מחובר בתור:</strong> ${this.escapeHtml(this.agentName())}`;
      }
      const medicalTopic = this.detectMedicalTopic(q);
      const underwriting = this.buildUnderwritingAnswer(q);
      const medical = medicalTopic ? this.buildMedicalAnswer(medicalTopic) : (this.isMedicalIntent(q) ? this.buildFallbackMedicalAnswer(q) : '');
      if(medical && underwriting){
        return `${medical}<br><br><hr style="border:none;border-top:1px solid rgba(15,23,42,.08);margin:10px 0"><br>${underwriting}`;
      }
      if(underwriting) return underwriting;
      if(medical) return medical;
      return `אני יכול לעזור בעיקר ב־<strong>חיתום רפואי</strong>, <strong>מחלות</strong> ו־<strong>תרופות</strong>.<br><br>נסה למשל:<ul class="investoList"><li>מה זה סוכרת סוג 2?</li><li>מטפורמין - מה זה?</li><li>חיתום סוכרת בפניקס</li><li>לחץ דם - חיתום בכל החברות</li></ul>`;
    },
    buildMedicalAnswer(topic){
      const title = this.escapeHtml(topic.title || 'נושא רפואי');
      const summary = this.escapeHtml(topic.summary || '');
      const bullets = Array.isArray(topic.bullets) ? `<ul class="investoList">${topic.bullets.map((b) => `<li>${this.escapeHtml(b)}</li>`).join('')}</ul>` : '';
      const meds = topic.meds ? `<span class="investoSectionTitle">טיפול/תרופות נפוצים</span>${this.escapeHtml(topic.meds)}` : '';
      const caution = topic.caution ? `<span class="investoSectionTitle">חשוב לדעת</span>${this.escapeHtml(topic.caution)}` : '';
      return `<strong>${title}</strong><br><span class="investoSectionTitle">מה זה</span>${summary}<br><br>${bullets}${meds ? `<br>${meds}` : ''}${caution ? `<br><br>${caution}` : ''}<br><br><span class="investoSectionTitle">מקור עבודה</span>מאגר רפואי פנימי של investo לשאלות כלליות. זה לא מחליף רופא.`;
    },
    buildFallbackMedicalAnswer(query){
      const escaped = this.escapeHtml(query);
      return `<strong>לא מצאתי תשובת בסיס מובנית עבור:</strong> ${escaped}<br><br>אני ממליץ לנסח את השאלה בצורה ממוקדת יותר, למשל:<ul class="investoList"><li>מה זה [שם מחלה]</li><li>מה עושה [שם תרופה]</li><li>חיתום [אבחנה] [שם חברה]</li></ul>`;
    },
    buildUnderwritingAnswer(query){
      if(!this.isUnderwritingIntent(query) && !this.detectConditionKey(query)) return '';
      const selectedCompanies = this.detectCompanyNames(query);
      const companies = selectedCompanies.length ? selectedCompanies : Object.keys(this.underwritingStructured);
      const conditionKey = this.detectConditionKey(query);
      const parts = [];
      parts.push(`<strong>חיתום - ${conditionKey ? this.escapeHtml(conditionKey) : 'איתור מסמך/כלל'}</strong>`);
      parts.push(`<span class="investoSectionTitle">מצב חיפוש</span>${selectedCompanies.length ? 'בוצע סינון לחברה שצוינה בשאלה.' : 'ברירת מחדל: כל החברות.'}`);
      const rows = companies.map((company) => {
        const structured = this.underwritingStructured[company] || {};
        let body = '';
        if(conditionKey && structured.conditions && structured.conditions[conditionKey]){
          body = structured.conditions[conditionKey];
        } else if(structured.generic){
          body = structured.generic;
        } else {
          body = this.companyDocs[company] || 'אין כלל מובנה זמין כרגע בגרסה הזו.';
        }
        return `<li><strong>${this.escapeHtml(company)}</strong> - ${this.escapeHtml(body)}</li>`;
      }).join('');
      parts.push(`<ul class="investoList">${rows}</ul>`);
      if(conditionKey && !selectedCompanies.length){
        parts.push(`<span class="investoSectionTitle">דיוק לנציג</span>אם תרצה תשובה ממוקדת יותר, כתוב למשל: "חיתום ${this.escapeHtml(conditionKey)} בפניקס" או "${this.escapeHtml(conditionKey)} בהראל".`);
      }
      parts.push(`<span class="investoSectionTitle">הערה</span>המערכת מחזירה תחילה את המידע שהוטמע מהמסמכים. בחלק מהחברות הקבצים נסרקו חלקית ולכן חלק מהכללים כרגע כלליים יותר ודורשים טיוב נוסף.`);
    ...
    hasSavedFabPosition(){
      try {
        const payload = JSON.parse(localStorage.getItem(this.fabStorageKey()) || 'null');
        return !!(payload && Number.isFinite(Number(payload.left)) && Number.isFinite(Number(payload.top)));
      } catch(_e){ return false; }
    },
    captureFabPosition(shouldPersist=true){
      const fab = this.els.fab;
      if(!fab || fab.classList.contains('is-hidden')) return;
      const rect = fab.getBoundingClientRect();
      if(!(rect.width > 0 && rect.height > 0)) return;
    ...
    restoreFabPosition(){
      ...
      try {
        const payload = JSON.parse(localStorage.getItem(this.fabStorageKey()) || 'null');
        if(payload && Number.isFinite(Number(payload.left)) && Number.isFinite(Number(payload.top))){
          fab.style.left = `${Math.round(Number(payload.left))}px`;
          fab.style.top = `${Math.round(Number(payload.top))}px`;
          fab.style.bottom = 'auto';
          fab.style.right = 'auto';
        }
      } catch(_e) {}
    ...
    saveFabPosition(){
      ...
      if(!fab) return;
      try {
        localStorage.setItem(this.fabStorageKey(), JSON.stringify({ left: parseFloat(fab.style.left) || 24, top: parseFloat(fab.style.top) || Math.max(24, window.innerHeight - 88), updatedAt: Date.now() }));
      } catch(_e) {}
    },
    clampFabToViewport(){
      const fab = this.els.fab;
      if(!fab || fab.classList.contains('is-hidden')) return;
      const rect = fab.getBoundingClientRect();
      const width = fab.offsetWidth || rect.width || 160;
      const height = fab.offsetHeight || rect.height || 56;
      let left = parseFloat(fab.style.left);
      let top = parseFloat(fab.style.top);
      if(!Number.isFinite(left) || !Number.isFinite(top)){
        left = Math.max(12, rect.left || 24);
        top = Math.max(12, rect.top || (window.innerHeight - height - 24));
      }
    ...
    repositionWindow(){
      const fab = this.els.fab;
      const win = this.els.window;
      if(!fab || !win || win.classList.contains('is-hidden')) return;
      const fabRect = fab.getBoundingClientRect();
      const width = Math.min(430, Math.max(320, win.offsetWidth || 430));
      const height = Math.min(window.innerHeight - 24, Math.max(360, win.offsetHeight || 620));
      let left = fabRect.left;
      let top = fabRect.top - height - 14;
      if(top < 12) top = Math.min(window.innerHeight - height - 12, fabRect.bottom + 12);
    ...
    initFabDrag(){
      ...
      const start = (clientX, clientY) => {
        const rect = fab.getBoundingClientRect();
        this.fabDrag = { startX: clientX, startY: clientY, offsetX: clientX - rect.left, offsetY: clientY - rect.top, moved: false };
        fab.classList.add('is-dragging');
      };
      const move = (clientX, clientY) => {
        if(!this.fabDrag) return;
        const dx = clientX - this.fabDrag.startX;
        const dy = clientY - this.fabDrag.startY;
        if(Math.abs(dx) > 5 || Math.abs(dy) > 5) this.fabDrag.moved = true;
        let left = clientX - this.fabDrag.offsetX;
        let top = clientY - this.fabDrag.offsetY;
        const width = fab.offsetWidth || 160;
      ...
      const end = () => {
        if(!this.fabDrag) return;
        this.fabWasDragged = !!this.fabDrag.moved;
        fab.classList.remove('is-dragging');
        this.fabDrag = null;
        this.saveFabPosition();
      };
      on(fab, 'pointerdown', (ev) => { start(ev.clientX, ev.clientY); fab.setPointerCapture?.(ev.pointerId); });
      on(fab, 'pointermove', (ev) => move(ev.clientX, ev.clientY));
      on(fab, 'pointerup', () => end());
      on(fab, 'pointercancel', () => end());
    },
    initWindowDrag(){
      const handle = this.els.dragHandle;
      const win = this.els.window;
      ...
      const start = (clientX, clientY) => {
        const rect = win.getBoundingClientRect();
        this.dragState = { offsetX: clientX - rect.left, offsetY: clientY - rect.top };
      };
      const move = (clientX, clientY) => {
        if(!this.dragState || win.classList.contains('is-hidden')) return;
        const width = win.offsetWidth || 420;
        const height = win.offsetHeight || 620;
      ...
      const end = () => { this.dragState = null; };
      on(handle, 'pointerdown', (ev) => { start(ev.clientX, ev.clientY); handle.setPointerCapture?.(ev.pointerId); });
      on(handle, 'pointermove', (ev) => move(ev.clientX, ev.clientY));
      on(handle, 'pointerup', () => end());
      on(handle, 'pointercancel', () => end());
    },
    onLogin(){
      this.refreshIdentity();
      this.greetedForSession = false;
      this.loadHistory();
      this.renderHistory();
      this.syncVisibility();
    },
  ...
  const __investoOriginalChatOnLogin = ChatUI.onLogin.bind(ChatUI);
  ChatUI.onLogin = function(){
    const result = __investoOriginalChatOnLogin();
    try { InvestoUI.onLogin(); } catch(_e) {}
    return result;
  };

  const __investoOriginalChatOnLogout = ChatUI.onLogout.bind(ChatUI);
  ChatUI.onLogout = function(){
    try { InvestoUI.onLogout(); } catch(_e) {}
    return __investoOriginalChatOnLogout();
  };

  const __investoOriginalGoView = UI.goView.bind(UI);
  UI.goView = function(view){
    const result = __investoOriginalGoView(view);
    try { InvestoUI.syncVisibility(view); } catch(_e) {}
    return result;
  };
