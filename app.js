...
(() => {
  ...
  const BUILD = "20260407-v59-login-apple-glass";
...
this.applyRoleUI();
    ...
    initSidebarCollapse(){
      const collapsed = localStorage.getItem(SIDEBAR_COLLAPSE_STORAGE_KEY) === "1";
      ...
      const supportBtn = document.getElementById('btnSupportNoticeOpen');
      if (supportBtn) {
        const supportLabel = safeTrim(supportBtn.querySelector('.sidebarRepairBtn__label')?.textContent) || 'פנייה לתמיכה';
        supportBtn.setAttribute('title', supportLabel);
        supportBtn.setAttribute('aria-label', supportLabel);
      }
    },
    ...
    renderEmpty(){
      ...
      this.els.root.innerHTML = `
        <section class="bankDash bankDash--empty">
          <div class="bankDash__topStats bankDash__topStats--empty card">
    ...
    render(){
      ...
      this.els.root.innerHTML = `
        <section class="bankDash bankDash--cleanTop">
          <div class="bankDash__topStats card">
