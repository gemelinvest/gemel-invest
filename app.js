...
// ==== PATCH: fix missing function + clear input after send ====
if (typeof window.upsertIncomingMessage !== "function") {
  window.upsertIncomingMessage = function(msg){
    console.log("Fallback upsertIncomingMessage", msg);
  };
}

// Clear chat input after send (safe generic hook)
document.addEventListener("submit", function(e){
  const form = e.target;
  if (form && form.querySelector && form.querySelector('input[type="text"], textarea')) {
