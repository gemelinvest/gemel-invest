    ...
    getStep1Questions(ins){
      ...
      return [
        ...
        },
        {
          key:'personalDetails',
          title:'פרטים אישיים',
          sub:'כאן מרכזים תאריך לידה, גיל, מין, קופת חולים, שב״ן, מצב משפחתי ועיסוק — הכל במסך אחד.',
          fields: isChild ? ['birthDate','gender','clinic','shaban'] : ['birthDate','gender','clinic','shaban','maritalStatus','occupation'],
          requiredMsg: isChild ? 'נא להשלים תאריך לידה, מין, קופת חולים ושב״ן לפני שממשיכים' : 'נא להשלים תאריך לידה, מין, קופת חולים, שב״ן, מצב משפחתי ועיסוק לפני שממשיכים',
          render:() => `
            <div class="lcStep1Group">
    ...
    getStep1SummaryValue(ins, q){
      ...
      switch(q?.key){
        ...
        case 'personalDetails': {
          ...
          if(safeTrim(d.clinic)) parts.push(safeTrim(d.clinic));
          if(safeTrim(d.shaban)) parts.push(safeTrim(d.shaban));
