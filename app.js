  ...
  function openPrintView(proposal){
    ...
    try {
      ...
      function lienCell(policy){
        ...
        const kind = String(lien.kind||'bank').trim();
      ...
      <body>
        <div class="page">
          ...
          <div class="footer">
            ...
            <div><img src="assets/logo-login-clean.png" alt="לוגו" style="height:34px;max-width:220px;object-fit:contain;opacity:.95"/></div>
          </div>
