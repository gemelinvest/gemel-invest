...
renderHealthCoversBox({ covers, attrName, prefix }){
  ...
  return `
    <div class="lcHealthCovers" data-health-covers="1">
      <div class="lcHealthCovers__title">כיסויים (חובה לבחור לפחות אחד)</div>
      <div class="lcHealthCovers__grid">${items}</div>
    </div>
  `;
},
