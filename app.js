...
(() => {
  ...
  const BUILD = "20260406-bankgoal-glass-1to1-v48";
              ...
              <div class="bankGoal__details">
                <div class="bankGoal__mainNumbers">
                  <div class="bankGoal__mainStat">
                    <span>יעד חודשי:</span>
                    <strong>${metrics.targetValue > 0 ? escapeHtml(this.formatMoney(metrics.targetValue)) : '₪0'}</strong>
                    <small>${metrics.targetValue > 0 ? `מוגדר בניהול משתמשים` : `טרם הוגדר יעד`}</small>
                  </div>
                  <div class="bankGoal__mainStat">
                ...
                <div class="bankGoal__miniCols">
                  <div class="bankGoal__miniStat">
                    <span>יעד נותר:</span>
                    <strong>${metrics.targetValue > 0 ? escapeHtml(this.formatMoney(metrics.targetRemaining)) : '₪0'}</strong>
                    <small>${metrics.targetValue > 0 ? `עד להשלמת היעד` : `ממתין להגדרת מנהל`}</small>
                  </div>
                  <div class="bankGoal__miniStat">
                    <span>נטו חודשי:</span>
                    <strong>${escapeHtml(this.formatMoney(metrics.netPremium))}</strong>
