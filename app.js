...
(() => {
  ...
  const BUILD = "20260409-vMfaLoaderUltraQuietCream";
  ...
  const WelcomeLoader = {
      ...
      root.innerHTML = `
        ...
        <div class="lcWelcomeLoader__panel" role="status" aria-live="polite" aria-atomic="true">
          <div class="lcWelcomeLoader__shell">
            <div class="lcWelcomeLoader__ambient" aria-hidden="true"></div>
            <div class="lcWelcomeLoader__content">
              ...
              <div class="lcWelcomeLoader__progress" aria-hidden="true">
                <span class="lcWelcomeLoader__progressTrack"></span>
                <span class="lcWelcomeLoader__progressFill"></span>
                <span class="lcWelcomeLoader__progressShine"></span>
              </div>
            </div>
          </div>
        </div>
    ...
    open(name){
      ...
      if(statusEl) statusEl.textContent = 'מאמת הרשאות';
      window.clearInterval(this.statusTimer);
      const statuses = ['מאמת הרשאות', 'טוען נתוני מערכת', 'מכין סביבת עבודה', 'כמעט מוכן'];
      let statusIndex = 0;
    ...
    async play(name, ms=4000){
      this.open(name);
      await new Promise(resolve => setTimeout(resolve, Math.max(1200, Number(ms) || 4000)));
      this.close();
    }
  };
