...
(() => {
  ...
  const BUILD = "20260323-health-covers-refresh-1";
...
txt.textContent = "";
  ...
  const Wizard = {
    ...
    // כיסויי בריאות (פוליסות בריאות בוויזארד)
    healthCovers: [
      { k:"ניתוחים ומחליפי ניתוח בישראל (משלים שב"ן)", sub:"רובד משלים לשב"ן לניתוחים וטיפולים מחליפי ניתוח בישראל" },
      { k:"ניתוחים ומחליפי ניתוח בישראל (שב"ן עם השתתפות עצמית 5,000 ₪)", sub:"כיסוי משלים שב"ן עם השתתפות עצמית של 5,000 ₪ לפי תנאי הפוליסה" },
      { k:"ניתוחים ומחליפי ניתוח בישראל מהשקל הראשון", sub:"כיסוי פרטי מלא לניתוחים וטיפולים מחליפי ניתוח בישראל" },
      { k:"טיפולים ומחליפי ניתוח בחו"ל", sub:"כיסוי לניתוחים, טיפולים ומחליפי ניתוח בחו"ל" },
      { k:"השתלות", sub:"כיסוי להשתלות וטיפולים מיוחדים בחו"ל" },
      { k:"תרופות", sub:"כיסוי לתרופות שאינן נכללות בסל או לפי התוויה רפואית" },
      { k:"אמבולטורי (ייעוצים ובדיקות)", sub:"ייעוצים, בדיקות אבחנתיות ושירותים אמבולטוריים" },
      { k:"אבחון מהיר", sub:"כתב שירות לאבחון מהיר ובדיקות בהסכם" },
      { k:"נספח כתב שירות לילד", sub:"כתב שירות ייעודי לילד לפי תנאי המוצר" },
      { k:"רפואה משלימה", sub:"טיפולי רפואה משלימה במסגרת כתב השירות" }
    ],
init(){
