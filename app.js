...
_applyInsuredType(type){
  ...
  // always copy address+zip for spouse; default-copy for adult; lock for spouse/minor
  const lockAddress = (t === "spouse" || t === "minor");
  const copyAddress = (t === "spouse" || t === "minor" || t === "adult");
  ...
  // kids copied for spouse (lock)
  if(t === "spouse"){
    setV("insured2_childrenCount", pKids);
  }

  // minor copies phone+email too (lock)
  if(t === "minor"){
  ...
  lock("insured2_address", lockAddress, this.els.insured2AddressHelp);
  lock("insured2_zipCode", lockAddress, this.els.insured2ZipHelp);
