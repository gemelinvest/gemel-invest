...
(() => {
  ...
  const BUILD = "20260404-step1-grouped-personal-v32";
...
// open health covers drawer (Health only)
    ...
    renderStep1Summary(ins, questions, activeIdx){
      ...
      return `<aside class="lcStep1Summary"><div class="lcStep1Summary__head"><div class="lcStep1Summary__title">תקציר ${escapeHtml(ins.label)}</div><div class="lcStep1Summary__sub">שלושת הבלוקים החדשים של שלב הפרטים האישיים</div></div><div class="lcStep1Summary__list">${summaryItems}</div></aside>`;
    },
    ...
    getInsuredDisplayName(ins){
      ...
      return safeTrim((first + " " + last).trim()) || safeTrim(ins?.label) || "מבוטח";
    },
