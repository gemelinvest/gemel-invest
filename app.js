  ...
  const Auth = {
    ...
    logout(reason = "manual"){
      ...
      try {
        ...
        if(isElectron){
          setTimeout(() => {
            try { window.location.href = 'electron://logout'; } catch(_e) {}
          }, 30);
        }
      } catch(_e) {}
    },
      ...
      const form = `<div class="lcWSection lcPolBuilderSection lcPolBuilderSection--reference">
        ...
        <div class="lcPolForm lcPolForm--premium lcPolForm--reference">
          <div class="lcPolBuilderCard lcPolBuilderCard--reference">
            ...
            <section class="lcPolReferenceBlock lcPolBuilderCompanies">
              <div class="lcPolReferenceBlock__head">
                <div>
                  <div class="lcPolReferenceBlock__title">בחירת חברה</div>
                  <div class="lcPolReferenceBlock__sub">בחרו את חברת הביטוח</div>
                </div>
                <div class="lcPolReferenceBlock__icon" aria-hidden="true">🏢</div>
              </div>
              <div class="lcCoGrid lcCoGrid--reference">${companyCards}</div>
            </section>

            <section class="lcPolReferenceBlock lcPolReferenceBlock--details lcPolReferenceBlock--detailsClean">
              <div class="lcPolGrid lcPolGrid--top lcPolGrid--mainRow lcPolGrid--reference">
