...
const SystemRepairUI = {
  ...
  const App = {
    ...
    async reloadSessionState(opts={}){
      ...
      const prevSection = preserveCustomerOpen ? safeTrim(CustomersUI.currentSection || 'wallet') : 'wallet';
      ...
      if (r.ok) {
        ...
        if(wasCustomerOpen){
          ...
          if(updatedRec){
            CustomersUI.currentSection = prevSection || 'wallet';
            CustomersUI.openById(openCustomerId, { skipLoader:true, preserveScroll:true, silentRefresh:true });
