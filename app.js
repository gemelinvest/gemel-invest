    ...
    renderStep9(){
      ...
      const renderExistingCards = () => {
        ...
        return `<div class="lcOpCards">` + existingPolicies.map((policy, idx) => {
          ...
          return `<article class="lcOpPolicyCard" style="animation-delay:${idx * 70}ms">
            ...
            ${policy.partialDetails ? `<div class="lcOpPolicyCard__note lcOpPolicyCard__note--partial">${escapeHtml(policy.partialDetails)}</div>` : ``}
          </article>`;
        }).join("") + `</div>`;
      };
      ...
      return `
        <section class="lcOpSummary">
          <div class="lcOpHero">
            <div class="lcOpHero__head">
              <div class="lcOpHero__brand" aria-label="InsureGen">
                <span class="lcOpHero__brandIconWrap">
                  <img src="./insuregen-badge.png" alt="InsureGen" class="lcOpHero__brandIcon" />
                </span>
                <span class="lcOpHero__brandText">InsureGen</span>
              </div>
              <div class="lcOpHero__intro">
