...
txt.textContent = "";
  ...
  const CustomerEditUI = {
    ...
    openSaveSuccess(message){
      ...
      if(this.els.successText) this.els.successText.textContent = safeTrim(message) || 'תיק הלקוח עודכן בהצלחה.';
      this.close();
...
// ---------- Step 6 ----------
    ...
    async exportOperationalPdf(payloadOverride){
      console.warn('Operational PDF export is disabled in this build until the new engine is implemented.', payloadOverride || null);
