...
console.log("\n5) UI + cache");
assert(html.includes("gi-daily-sales-mail.js?v=20260907-customer-doc-preview-v1"), "cache bust לסקריפט המייל");
assert(mail.includes("20260907-customer-doc-preview-v1"), "כותרת הסקריפט");
