...
console.log("\n5) UI + cache");
assert(html.includes("gi-daily-sales-mail.js?v=20260907-ops-mirror-compact-ux-v1"), "cache bust לסקריפט המייל");
assert(mail.includes("20260907-ops-mirror-compact-ux-v1"), "כותרת הסקריפט");
