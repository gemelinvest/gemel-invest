...
| 9b | F1 | אוטומציות בדפדפן **+ רינדורים כפולים**: ציור אחד למסך גלוי, coalescing, מקור sync אחד, backoff, לידים/conflict בלי `select("*")`, hydrate ל־working-set | נמוך–בינוני | אחרי F0 | מקביל ל־Pא–Pד; מוקפא ב־Pה |
