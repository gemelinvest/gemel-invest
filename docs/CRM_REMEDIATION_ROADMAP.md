...
| 9d | F1.2 | select צר ללידים + מיזוג קונפליקט לפי מזהים (בלי `select("*")` מלא) | נמוך | אושר | **ביישום** (PR #206) |
| 9e | Pז / R6–R8 ישן | select צר / איחוד sync — מכוסה ב־F1–F3 | נמוך–בינוני | כן | אחרי F0 |
