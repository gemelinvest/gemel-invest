...
| 9 | F0 | ביצועים: מוני `render`/`goView`/טיימרים (`giPerfCounts`) — בלי שינוי לוגיקה | אין | אושר | **ביישום / PR** |
| 9b | F1–F3 | רינדורים כפולים, sync, hydrate, ליבת טעינה | נמוך–בינוני | אחרי צילום בסיס F0 | ממתין |
| 9c | Pז / R6–R8 ישן | select צר / איחוד sync — מכוסה ב־F1–F3 | נמוך–בינוני | כן | אחרי F0 |
