...
assert(indexHtml.includes("app.js?v=20260826-daily-sales-branch-v2"), "cache bust ל-app.js");
assert(indexHtml.includes("app.css?v=20260826-daily-sales-branch-v2"), "cache bust ל-app.css");
assert(sw.includes("20260826-daily-sales-branch-v2"), "service-worker cache version");
