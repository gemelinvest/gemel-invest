...
assert(indexHtml.includes("app.js?v=20260826-live-fix-v1"), "cache bust ל-app.js");
assert(indexHtml.includes("app.css?v=20260826-live-fix-v1"), "cache bust ל-app.css");
assert(sw.includes("20260826-live-fix-v1"), "service-worker cache version");
